 ...
 */
public async priceRule<TSelection extends Exact<InferSelectType<QueryRoot["priceRule"]>, TSelection>>(queryArgs: TSelection): Promise<GraphQLApiResponse<InferSelectedReturnType<QueryRoot["priceRule"], TSelection>>> {
 ...
 */
public async priceRuleSavedSearches<TSelection extends Exact<InferSelectType<QueryRoot["priceRuleSavedSearches"]>, TSelection>>(queryArgs: TSelection): Promise<GraphQLApiResponse<InferSelectedReturnType<QueryRoot["priceRuleSavedSearches"], TSelection>>> {
 ...
 */
public async priceRules<TSelection extends Exact<InferSelectType<QueryRoot["priceRules"]>, TSelection>>(queryArgs: TSelection): Promise<GraphQLApiResponse<InferSelectedReturnType<QueryRoot["priceRules"], TSelection>>> {
