...
export class GraphQLFlowMutationClient {
     ...
     */
    public async backupRegionUpdate<
        TSelection extends Exact<InferSelectType<Mutation["backupRegionUpdate"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<InferSelectedReturnType<Mutation["backupRegionUpdate"], TSelection>>
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
            "backupRegionUpdate",
     ...
     */
    public async companyLocationTaxSettingsUpdate<
        TSelection extends Exact<
            InferSelectType<Mutation["companyLocationTaxSettingsUpdate"]>,
            TSelection
        >,
    >(
        mutationArgs: TSelection
        ...
        GraphQLApiResponse<
            InferSelectedReturnType<Mutation["companyLocationTaxSettingsUpdate"], TSelection>
        >
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
     ...
     */
    public async consentPolicyUpdate<
        TSelection extends Exact<InferSelectType<Mutation["consentPolicyUpdate"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<InferSelectedReturnType<Mutation["consentPolicyUpdate"], TSelection>>
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
            "consentPolicyUpdate",
     ...
     */
    public async customerAddressCreate<
        TSelection extends Exact<InferSelectType<Mutation["customerAddressCreate"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<InferSelectedReturnType<Mutation["customerAddressCreate"], TSelection>>
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
     ...
     */
    public async customerAddressDelete<
        TSelection extends Exact<InferSelectType<Mutation["customerAddressDelete"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<InferSelectedReturnType<Mutation["customerAddressDelete"], TSelection>>
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
     ...
     */
    public async customerAddressUpdate<
        TSelection extends Exact<InferSelectType<Mutation["customerAddressUpdate"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<InferSelectedReturnType<Mutation["customerAddressUpdate"], TSelection>>
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
     ...
     */
    public async customerSet<
        TSelection extends Exact<InferSelectType<Mutation["customerSet"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<GraphQLApiResponse<InferSelectedReturnType<Mutation["customerSet"], TSelection>>> {
     ...
     */
    public async deliveryPromiseParticipantsUpdate<
        TSelection extends Exact<
            InferSelectType<Mutation["deliveryPromiseParticipantsUpdate"]>,
            TSelection
        >,
    >(
        mutationArgs: TSelection
        ...
        GraphQLApiResponse<
            InferSelectedReturnType<Mutation["deliveryPromiseParticipantsUpdate"], TSelection>
        >
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
     ...
     * fully paid.
     */
    public async orderCreateManualPayment<
        TSelection extends Exact<InferSelectType<Mutation["orderCreateManualPayment"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<
            InferSelectedReturnType<Mutation["orderCreateManualPayment"], TSelection>
        >
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
     ...
     */
    public async privacyFeaturesDisable<
        TSelection extends Exact<InferSelectType<Mutation["privacyFeaturesDisable"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<InferSelectedReturnType<Mutation["privacyFeaturesDisable"], TSelection>>
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
     ...
     */
    public async webPresenceCreate<
        TSelection extends Exact<InferSelectType<Mutation["webPresenceCreate"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<InferSelectedReturnType<Mutation["webPresenceCreate"], TSelection>>
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
            "webPresenceCreate",
     ...
     */
    public async webPresenceDelete<
        TSelection extends Exact<InferSelectType<Mutation["webPresenceDelete"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<InferSelectedReturnType<Mutation["webPresenceDelete"], TSelection>>
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
            "webPresenceDelete",
     ...
     */
    public async webPresenceUpdate<
        TSelection extends Exact<InferSelectType<Mutation["webPresenceUpdate"]>, TSelection>,
    >(
        mutationArgs: TSelection
    ): Promise<
        GraphQLApiResponse<InferSelectedReturnType<Mutation["webPresenceUpdate"], TSelection>>
    > {
        const generatedMutation = buildGraphQLOperation(
            "mutation",
            "webPresenceUpdate",
