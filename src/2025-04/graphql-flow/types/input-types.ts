...
export type ArticleCreateInput = {
     ...
     */
    isPublished?: BaseTypes.Boolean | null;
...
export type BlogCreateInput = {
     ...
     */
    commentPolicy?: BaseTypes.CommentPolicy | null;
...
export type BlogUpdateInput = {
     ...
     */
    redirectArticles?: BaseTypes.Boolean | null;
...
export type CatalogContextInput = {
     ...
     */
    marketIds?: Array<BaseTypes.ID> | null;
};
...
export type CheckoutBrandingMerchandiseThumbnailBadgeInput = {
     ...
     */
    background?: BaseTypes.CheckoutBrandingMerchandiseThumbnailBadgeBackground | null;
};
...
export type CheckoutBrandingMerchandiseThumbnailInput = {
     ...
     */
    badge?: CheckoutBrandingMerchandiseThumbnailBadgeInput | null;
     ...
     */
    fit?: BaseTypes.CheckoutBrandingObjectFit | null;
};
...
export type CollectionIdentifierInput = {
     ...
     */
    customId?: UniqueMetafieldValueInput | null;
...
export type ConsentPolicyInput = {
     ...
     */
    consentRequired?: BaseTypes.Boolean | null;

    /**
     * The `ISO 3166` country code for which the policy applies.
     */
    countryCode?: BaseTypes.PrivacyCountryCode | null;

    /**
     * Whether data sale opt-out is required for the region.
     */
    dataSaleOptOutRequired?: BaseTypes.Boolean | null;

    /**
     * The `ISO 3166` region code for which the policy applies.
     */
    regionCode?: BaseTypes.String | null;
};
...
export type CustomerEmailMarketingConsentInput = {
     ...
     */
    sourceLocationId?: BaseTypes.ID | null;
};
...
export type CustomerIdentifierInput = {
     ...
     */
    emailAddress?: BaseTypes.String | null;
     ...
     */
    phoneNumber?: BaseTypes.String | null;
};
...
export type DiscountAutomaticAppInput = {
     ...
     */
    discountClasses?: Array<BaseTypes.DiscountClass> | null;
...
export type DiscountCustomerBuysInput = {
     ...
     */
    isOneTimePurchase?: BaseTypes.Boolean | null;

    /**
     * If the discount is applicable when a customer buys a subscription purchase.
     */
    isSubscription?: BaseTypes.Boolean | null;
...
export type DraftOrderInput = {
     ...
     */
    localizedFields?: Array<LocalizedFieldInput> | null;
...
export type DraftOrderLineItemInput = {
     ...
     */
    components?: Array<DraftOrderLineItemComponentInput> | null;
     ...
     */
    generatePriceOverride?: BaseTypes.Boolean | null;
...
export type EventBridgeWebhookSubscriptionInput = {
     ...
     */
    metafields?: Array<HasMetafieldsMetafieldIdentifierInput> | null;
};
...
export type GiftCardCreateInput = {
     ...
     */
    recipientAttributes?: GiftCardRecipientInput | null;
...
export type GiftCardCreditInput = {
     ...
     */
    processedAt?: BaseTypes.DateTime | null;
};
...
export type GiftCardRecipientInput = {
     ...
     */
    preferredName?: BaseTypes.String | null;
     ...
     */
    sendNotificationAt?: BaseTypes.DateTime | null;
};
...
export type LocalizedFieldInput = {
     ...
     */
    key: BaseTypes.LocalizedFieldKey;
...
export type MarketConditionsCompanyLocationsInput = {
    /**
     * A type of market condition (e.g. NONE, ALL) to apply.
     */
    applicationLevel?: BaseTypes.MarketConditionApplicationType | null;
...
export type MarketConditionsInput = {
     ...
     */
    companyLocationsCondition?: MarketConditionsCompanyLocationsInput | null;

    /**
     * The locations to include in the market conditions.
     */
    locationsCondition?: MarketConditionsLocationsInput | null;

    /**
     * The regions to include in the market conditions.
     */
    regionsCondition?: MarketConditionsRegionsInput | null;
};
...
export type MarketConditionsLocationsInput = {
     ...
     */
    locationIds?: Array<BaseTypes.ID> | null;
};
...
export type MarketConditionsRegionsInput = {
     ...
     */
    regionIds?: Array<BaseTypes.ID> | null;

    /**
     * A list of market regions to include in the market condition.
     */
    regions?: Array<MarketConditionsRegionInput> | null;
};
...
export type MarketConditionsUpdateInput = {
     ...
     */
    conditionsToAdd?: MarketConditionsInput | null;

    /**
     * The conditions to delete from the market condition.
     */
    conditionsToDelete?: MarketConditionsInput | null;
};
...
export type MarketCreateInput = {
     ...
     */
    catalogs?: Array<BaseTypes.ID> | null;

    /**
     * The conditions that apply to the market.
     */
    conditions?: MarketConditionsInput | null;

    /**
     * Currency settings for the market.
     */
    currencySettings?: MarketCurrencySettingsUpdateInput | null;
     ...
     */
    makeDuplicateUniqueMarketsDraft?: BaseTypes.Boolean | null;
     ...
     */
    priceInclusions?: MarketPriceInclusionsInput | null;

    /**
     * The status of the market.
     */
    status?: BaseTypes.MarketStatus | null;

    /**
     * Web presence IDs to include in the market.
     */
    webPresences?: Array<BaseTypes.ID> | null;
};
...
export type MarketCurrencySettingsUpdateInput = {
     ...
     */
    baseCurrencyManualRate?: BaseTypes.Decimal | null;
     ...
     */
    roundingEnabled?: BaseTypes.Boolean | null;
};
...
export type MarketPriceInclusionsInput = {
     ...
     */
    dutiesPricingStrategy?: BaseTypes.InclusiveDutiesPricingStrategy | null;

    /**
     * The inclusive tax pricing strategy for the market.
     */
    taxPricingStrategy?: BaseTypes.InclusiveTaxPricingStrategy | null;
};
...
export type MarketUpdateInput = {
     ...
     * Catalog IDs to include in the market.
     */
    catalogsToAdd?: Array<BaseTypes.ID> | null;

    /**
     * Catalog IDs to remove from the market.
     */
    catalogsToDelete?: Array<BaseTypes.ID> | null;

    /**
     * The conditions to update.
     */
    conditions?: MarketConditionsUpdateInput | null;
     ...
     */
    removeCurrencySettings?: BaseTypes.Boolean | null;

    /**
     * The price inclusions to remove from the market.
     */
    removePriceInclusions?: BaseTypes.Boolean | null;
     ...
     */
    webPresencesToAdd?: Array<BaseTypes.ID> | null;

    /**
     * The web presences to remove from the market.
     */
    webPresencesToDelete?: Array<BaseTypes.ID> | null;
};
...
export type MetafieldAccessInput = {
     ...
     */
    admin?: BaseTypes.MetafieldAdminAccessInput | null;
...
export type MetafieldCapabilityCreateInput = {
     ...
     */
    adminFilterable?: MetafieldCapabilityAdminFilterableInput | null;

    /**
     * The input for updating the smart collection condition capability.
     */
    smartCollectionCondition?: MetafieldCapabilitySmartCollectionConditionInput | null;

    /**
     * The input for updating the unique values capability.
     */
    uniqueValues?: MetafieldCapabilityUniqueValuesInput | null;
};
...
export type MetafieldDefinitionConstraintValueUpdateInput = {
     ...
     */
    create?: BaseTypes.String | null;

    /**
     * The constraint subtype value to delete.
     */
    delete?: BaseTypes.String | null;
};
...
export type MetafieldDefinitionConstraintsUpdatesInput = {
     ...
     */
    values?: Array<MetafieldDefinitionConstraintValueUpdateInput> | null;
};
...
export type MetafieldDefinitionInput = {
     ...
     */
    capabilities?: MetafieldCapabilityCreateInput | null;
     ...
     */
    constraints?: MetafieldDefinitionConstraintsInput | null;
...
export type MetafieldDefinitionUpdateInput = {
     ...
     * The capabilities of the metafield definition.
     */
    capabilities?: MetafieldCapabilityUpdateInput | null;

    /**
     * The [constraints](https://shopify.dev/apps/build/custom-data/metafields/conditional-metafield-definitions)
     * that determine what resources a metafield definition applies to.
     */
    constraintsUpdates?: MetafieldDefinitionConstraintsUpdatesInput | null;
...
export type MetaobjectAccessInput = {
     ...
     * The access permitted on the Admin API.
     */
    admin?: BaseTypes.MetaobjectAdminAccessInput | null;
...
export type OnlineStoreThemeFileBodyInput = {
     ...
     */
    type: BaseTypes.OnlineStoreThemeFileBodyInputType;
...
export type OrderCreateCustomerInput = {
     ...
     */
    toAssociate?: OrderCreateAssociateCustomerAttributesInput | null;

    /**
     * A new customer to create or update and associate with the order.
     */
    toUpsert?: OrderCreateUpsertCustomerAttributesInput | null;
};
...
export type OrderCreateDiscountCodeInput = {
     ...
     */
    freeShippingDiscountCode?: OrderCreateFreeShippingDiscountCodeAttributesInput | null;

    /**
     * A fixed amount discount code applied to the line items on the order.
     */
    itemFixedDiscountCode?: OrderCreateFixedDiscountCodeAttributesInput | null;

    /**
     * A percentage discount code applied to the line items on the order.
     */
    itemPercentageDiscountCode?: OrderCreatePercentageDiscountCodeAttributesInput | null;
};
...
export type OrderCreateFulfillmentInput = {
     ...
     */
    shipmentStatus?: BaseTypes.FulfillmentEventStatus | null;
     ...
     * > (capitalization matters).
     */
    trackingCompany?: BaseTypes.String | null;
     ...
     * This can result in an invalid tracking URL.
     */
    trackingNumber?: BaseTypes.String | null;
};
...
export type OrderCreateLineItemInput = {
     ...
     */
    fulfillmentService?: BaseTypes.String | null;
     ...
     */
    properties?: Array<OrderCreateLineItemPropertyInput> | null;
     ...
     */
    taxLines?: Array<OrderCreateTaxLineInput> | null;
     ...
     */
    variantTitle?: BaseTypes.String | null;
...
export type OrderCreateOptionsInput = {
     ...
     */
    inventoryBehaviour?: BaseTypes.OrderCreateInputsInventoryBehavior | null;

    /**
     * Whether to send a shipping confirmation to the customer.
     */
    sendFulfillmentReceipt?: BaseTypes.Boolean | null;

    /**
     * Whether to send an order confirmation to the customer.
     */
    sendReceipt?: BaseTypes.Boolean | null;
};
...
export type OrderCreateOrderInput = {
     ...
     */
    buyerAcceptsMarketing?: BaseTypes.Boolean | null;
     ...
     */
    closedAt?: BaseTypes.DateTime | null;
     ...
     */
    customAttributes?: Array<OrderCreateCustomAttributeInput> | null;

    /**
     * The customer to associate to the order.
     */
    customer?: OrderCreateCustomerInput | null;

    /**
     * A discount code applied to the order.
     */
    discountCode?: OrderCreateDiscountCodeInput | null;
     ...
     */
    financialStatus?: BaseTypes.OrderCreateFinancialStatus | null;

    /**
     * The fulfillment to create for the order. This will apply to all line items.
     */
    fulfillment?: OrderCreateFulfillmentInput | null;

    /**
     * The fulfillment status of the order. Will default to `unfulfilled` if not included.
     */
    fulfillmentStatus?: BaseTypes.OrderCreateFulfillmentStatus | null;

    /**
     * The line items to create for the order.
     */
    lineItems?: Array<OrderCreateLineItemInput> | null;
     ...
     */
    presentmentCurrency?: BaseTypes.CurrencyCode | null;
     ...
     */
    referringSite?: BaseTypes.URL | null;
     ...
     */
    shippingLines?: Array<OrderCreateShippingLineInput> | null;
     ...
     */
    sourceIdentifier?: BaseTypes.String | null;
     ...
     */
    taxesIncluded?: BaseTypes.Boolean | null;

    /**
     * Whether this is a test order.
     */
    test?: BaseTypes.Boolean | null;

    /**
     * The payment transactions to create for the order.
     */
    transactions?: Array<OrderCreateOrderTransactionInput> | null;
...
export type OrderCreateOrderTransactionInput = {
     ...
     */
    authorizationCode?: BaseTypes.String | null;

    /**
     * The ID of the device used to process the transaction.
     */
    deviceId?: BaseTypes.ID | null;

    /**
     * The name of the gateway the transaction was issued through.
     */
    gateway?: BaseTypes.String | null;

    /**
     * The ID of the gift card used for this transaction.
     */
    giftCardId?: BaseTypes.ID | null;

    /**
     * The kind of transaction.
     */
    kind?: BaseTypes.OrderTransactionKind | null;
     ...
     */
    receiptJson?: BaseTypes.JSON | null;

    /**
     * The status of the transaction.
     */
    status?: BaseTypes.OrderTransactionStatus | null;
...
export type OrderCreateTaxLineInput = {
     ...
     */
    channelLiable?: BaseTypes.Boolean | null;
...
export type OrderCreateUpsertCustomerAttributesInput = {
     ...
     */
    addresses?: Array<OrderCreateCustomerAddressInput> | null;
     ...
     */
    multipassIdentifier?: BaseTypes.String | null;
...
export type ProductUpdateInput = {
     ...
     */
    deleteConflictingConstrainedMetafields?: BaseTypes.Boolean | null;
...
export type ProductVariantSetInput = {
     ...
     */
    inventoryQuantities?: Array<ProductSetInventoryInput> | null;
...
export type QuantityPricingByVariantUpdateInput = {
     ...
     */
    quantityPriceBreaksToDeleteByVariantId?: Array<BaseTypes.ID> | null;
...
export type RefundInput = {
     ...
     */
    discrepancyReason?: BaseTypes.OrderAdjustmentInputDiscrepancyReason | null;
...
export type ReturnDeclineRequestInput = {
     ...
     */
    declineNote?: BaseTypes.String | null;
...
export type SubscriptionBillingAttemptInput = {
     ...
     */
    inventoryPolicy?: BaseTypes.SubscriptionBillingAttemptInventoryPolicy | null;
...
export type ThemeFilesCopyFileInput = {
     ...
     */
    dstFilename: BaseTypes.String;

    /**
     * The source file to copy from.
     */
    srcFilename: BaseTypes.String;
};
