 ...
 */
export type AbandonedCheckoutSortKeys = "CHECKOUT_ID" | "CREATED_AT" | "CUSTOMER_NAME" | "ID" | "RELEVANCE" | "TOTAL_PRICE"
 ...
 */
export type AbandonmentUpdateActivitiesDeliveryStatusesUserErrorCode = "ABANDONMENT_NOT_FOUND" | "DELIVERY_STATUS_INFO_NOT_FOUND" | "MARKETING_ACTIVITY_NOT_FOUND"

/**
 * Possible account types that a staff member can have.
 */
export type AccountType = "COLLABORATOR" | "COLLABORATOR_TEAM_MEMBER" | "INVITED" | "INVITED_STORE_OWNER" | "REGULAR" | "REQUESTED" | "RESTRICTED" | "SAML"
 ...
 */
export type AppRevokeAccessScopesAppRevokeScopeErrorCode = "APPLICATION_CANNOT_BE_FOUND" | "APP_NOT_INSTALLED" | "CANNOT_REVOKE_IMPLIED_SCOPES" | "CANNOT_REVOKE_REQUIRED_SCOPES" | "CANNOT_REVOKE_UNDECLARED_SCOPES" | "MISSING_SOURCE_APP" | "UNKNOWN_SCOPES"
 ...
 */
export type AppSubscriptionTrialExtendUserErrorCode = "SUBSCRIPTION_NOT_ACTIVE" | "SUBSCRIPTION_NOT_FOUND" | "TRIAL_NOT_ACTIVE"
 ...
 */
export type ArticleCreateUserErrorCode = "AMBIGUOUS_AUTHOR" | "AMBIGUOUS_BLOG" | "AUTHOR_FIELD_REQUIRED" | "AUTHOR_MUST_EXIST" | "BLANK" | "BLOG_REFERENCE_REQUIRED" | "INVALID" | "INVALID_PUBLISH_DATE" | "INVALID_TYPE" | "INVALID_VALUE" | "NOT_FOUND" | "TAKEN" | "TOO_LONG" | "UPLOAD_FAILED"
 ...
 */
export type ArticleSortKeys = "AUTHOR" | "BLOG_TITLE" | "ID" | "PUBLISHED_AT" | "TITLE" | "UPDATED_AT"
 ...
 */
export type ArticleUpdateUserErrorCode = "AMBIGUOUS_AUTHOR" | "AMBIGUOUS_BLOG" | "AUTHOR_MUST_EXIST" | "BLANK" | "INVALID" | "INVALID_PUBLISH_DATE" | "NOT_FOUND" | "TAKEN" | "TOO_LONG" | "UPLOAD_FAILED"
 ...
 */
export type BalanceTransactionSortKeys = "AMOUNT" | "FEE" | "ID" | "NET" | "ORDER_NAME" | "PAYMENT_METHOD_NAME" | "PAYOUT_DATE" | "PAYOUT_STATUS" | "PROCESSED_AT" | "TRANSACTION_TYPE"

/**
 * The valid types of actions a user should be able to perform in an financial app.
 */
export type BankingFinanceAppAccess = "MONEY_MOVEMENT_BLOCKED_MFA" | "MONEY_MOVEMENT_RESTRICTED" | "MOVE_MONEY" | "READ_ACCESS"

/**
 * Possible error codes that can be returned by `BillingAttemptUserError`.
 */
export type BillingAttemptUserErrorCode = "BILLING_CYCLE_CHARGE_BEFORE_EXPECTED_DATE" | "BILLING_CYCLE_SKIPPED" | "BLANK" | "CONTRACT_NOT_FOUND" | "CONTRACT_PAUSED" | "CONTRACT_TERMINATED" | "CONTRACT_UNDER_REVIEW" | "CYCLE_INDEX_OUT_OF_RANGE" | "CYCLE_START_DATE_OUT_OF_RANGE" | "INVALID" | "ORIGIN_TIME_BEFORE_CONTRACT_CREATION" | "ORIGIN_TIME_OUT_OF_RANGE" | "UPCOMING_CYCLE_LIMIT_EXCEEDED"

/**
 * Possible error codes that can be returned by `BlogCreateUserError`.
 */
export type BlogCreateUserErrorCode = "INCLUSION" | "INVALID" | "INVALID_TYPE" | "INVALID_VALUE" | "TOO_LONG"
 ...
 */
export type BulkMutationErrorCode = "INTERNAL_FILE_SERVER_ERROR" | "INVALID_MUTATION" | "INVALID_STAGED_UPLOAD_FILE" | "NO_SUCH_FILE" | "OPERATION_IN_PROGRESS"
 ...
 */
export type BulkProductResourceFeedbackCreateUserErrorCode = "BLANK" | "INVALID" | "LESS_THAN_OR_EQUAL_TO" | "MAXIMUM_FEEDBACK_LIMIT_EXCEEDED" | "OUTDATED_FEEDBACK" | "PRESENT" | "PRODUCT_NOT_FOUND"

/**
 * Possible error codes that can be returned by `BusinessCustomerUserError`.
 */
export type BusinessCustomerErrorCode = "BLANK" | "FAILED_TO_DELETE" | "INTERNAL_ERROR" | "INVALID" | "INVALID_INPUT" | "LIMIT_REACHED" | "NO_INPUT" | "REQUIRED" | "RESOURCE_NOT_FOUND" | "TAKEN" | "TOO_LONG" | "UNEXPECTED_TYPE"
 ...
 */
export type CartTransformCreateUserErrorCode = "FUNCTION_ALREADY_REGISTERED" | "FUNCTION_DOES_NOT_IMPLEMENT" | "FUNCTION_NOT_FOUND" | "INPUT_INVALID" | "INVALID_METAFIELDS"
 ...
 */
export type CashTrackingSessionsSortKeys = "CLOSING_TIME_ASC" | "CLOSING_TIME_DESC" | "ID" | "OPENING_TIME_ASC" | "OPENING_TIME_DESC" | "TOTAL_DISCREPANCY_ASC" | "TOTAL_DISCREPANCY_DESC"
 ...
 */
export type CatalogUserErrorCode = "APP_CATALOG_PRICE_LIST_ASSIGNMENT" | "BLANK" | "CANNOT_ADD_MORE_THAN_ONE_MARKET" | "CANNOT_CREATE_APP_CATALOG" | "CANNOT_CREATE_MARKET_CATALOG" | "CANNOT_DELETE_APP_CATALOG" | "CANNOT_DELETE_MARKET_CATALOG" | "CANNOT_MODIFY_APP_CATALOG" | "CANNOT_MODIFY_MARKET_CATALOG" | "CATALOG_CONTEXT_DOES_NOT_SUPPORT_QUANTITY_PRICE_BREAKS" | "CATALOG_CONTEXT_DOES_NOT_SUPPORT_QUANTITY_RULES" | "CATALOG_FAILED_TO_SAVE" | "CATALOG_NOT_FOUND" | "COMPANY_LOCATION_CATALOG_STATUS_PLAN" | "COMPANY_LOCATION_NOT_FOUND" | "CONTEXT_ALREADY_ASSIGNED_TO_CATALOG" | "CONTEXT_CATALOG_LIMIT_REACHED" | "CONTEXT_DRIVER_MISMATCH" | "COUNTRY_CATALOG_PRICE_LIST_ASSIGNMENT" | "COUNTRY_PRICE_LIST_ASSIGNMENT" | "INVALID" | "INVALID_CATALOG_CONTEXT_TYPE" | "INVALID_CONTEXT_CHANGE" | "MANAGED_COUNTRY_BELONGS_TO_ANOTHER_CATALOG" | "MARKET_AND_PRICE_LIST_CURRENCY_MISMATCH" | "MARKET_CATALOG_STATUS" | "MARKET_NOT_FOUND" | "MARKET_TAKEN" | "MUST_PROVIDE_EXACTLY_ONE_CONTEXT_TYPE" | "PRICE_LIST_FAILED_TO_SAVE" | "PRICE_LIST_LOCKED" | "PRICE_LIST_NOT_ALLOWED_FOR_PRIMARY_MARKET" | "PRICE_LIST_NOT_FOUND" | "PUBLICATION_NOT_FOUND" | "REQUIRES_CONTEXTS_TO_ADD_OR_REMOVE" | "TAKEN" | "TOO_LONG" | "TOO_SHORT" | "UNPERMITTED_ENTITLEMENTS_MARKET_CATALOGS" | "UNSUPPORTED_CATALOG_ACTION"
 ...
 */
export type CheckoutBrandingColorSchemeSelection = "COLOR_SCHEME1" | "COLOR_SCHEME2" | "COLOR_SCHEME3" | "COLOR_SCHEME4" | "TRANSPARENT"
 ...
 */
export type CheckoutBrandingFontLoadingStrategy = "AUTO" | "BLOCK" | "FALLBACK" | "OPTIONAL" | "SWAP"
 ...
 */
export type CheckoutBrandingSpacing = "BASE" | "EXTRA_LOOSE" | "EXTRA_TIGHT" | "LOOSE" | "NONE" | "TIGHT"

/**
 * The spacing between UI elements.
 */
export type CheckoutBrandingSpacingKeyword = "BASE" | "LARGE" | "LARGE_100" | "LARGE_200" | "LARGE_300" | "LARGE_400" | "LARGE_500" | "NONE" | "SMALL" | "SMALL_100" | "SMALL_200" | "SMALL_300" | "SMALL_400" | "SMALL_500"
 ...
 */
export type CheckoutBrandingTypographySize = "BASE" | "EXTRA_EXTRA_LARGE" | "EXTRA_LARGE" | "EXTRA_SMALL" | "LARGE" | "MEDIUM" | "SMALL"
 ...
 */
export type CheckoutProfileSortKeys = "CREATED_AT" | "EDITED_AT" | "ID" | "IS_PUBLISHED" | "UPDATED_AT"

/**
 * The set of valid sort keys for the CodeDiscount query.
 */
export type CodeDiscountSortKeys = "CREATED_AT" | "ENDS_AT" | "ID" | "RELEVANCE" | "STARTS_AT" | "TITLE" | "UPDATED_AT"
 ...
 */
export type CollectionRuleColumn = "IS_PRICE_REDUCED" | "PRODUCT_CATEGORY_ID" | "PRODUCT_METAFIELD_DEFINITION" | "PRODUCT_TAXONOMY_NODE_ID" | "TAG" | "TITLE" | "TYPE" | "VARIANT_COMPARE_AT_PRICE" | "VARIANT_INVENTORY" | "VARIANT_METAFIELD_DEFINITION" | "VARIANT_PRICE" | "VARIANT_TITLE" | "VARIANT_WEIGHT" | "VENDOR"
 ...
 */
export type CombinedListingUpdateUserErrorCode = "CANNOT_HAVE_DUPLICATED_PRODUCTS" | "CANNOT_HAVE_PARENT_AS_CHILD" | "CANNOT_HAVE_REPEATED_OPTIONS" | "CANNOT_HAVE_REPEATED_OPTION_VALUES" | "CANT_ADD_OPTIONS_VALUES_IF_ALREADY_EXISTS" | "COMBINED_LISTINGS_NOT_ENABLED" | "EDIT_AND_REMOVE_ON_SAME_PRODUCTS" | "FAILED_TO_ADD_PRODUCTS" | "FAILED_TO_REMOVE_PRODUCTS" | "FAILED_TO_UPDATE_PRODUCTS" | "LINKED_METAFIELDS_CANNOT_BE_REPEATED" | "LINKED_METAFIELD_CANNOT_BE_CHANGED" | "LINKED_METAFIELD_VALUE_MISSING" | "LINKED_OPTIONS_NOT_SUPPORTED_FOR_SHOP" | "MISSING_OPTION_VALUES" | "MUST_HAVE_SELECTED_OPTION_VALUES" | "OPTIONS_MUST_BE_EQUAL_TO_THE_OTHER_COMPONENTS" | "OPTION_NAME_CANNOT_BE_BLANK" | "OPTION_NAME_CONTAINS_INVALID_CHARACTERS" | "OPTION_NOT_FOUND" | "OPTION_VALUES_CANNOT_BE_BLANK" | "OPTION_VALUES_CANNOT_BE_EMPTY" | "PARENT_PRODUCT_CANNOT_BE_COMBINED_LISTING_CHILD" | "PARENT_PRODUCT_MUST_BE_A_COMBINED_LISTING" | "PARENT_PRODUCT_NOT_FOUND" | "PRODUCT_IS_ALREADY_A_CHILD" | "PRODUCT_MEMBERSHIP_NOT_FOUND" | "PRODUCT_NOT_FOUND" | "TITLE_TOO_LONG" | "TOO_MANY_PRODUCTS" | "TOO_MANY_VARIANTS" | "UNEXPECTED_ERROR"
 ...
 */
export type CompanyContactRoleAssignmentSortKeys = "CREATED_AT" | "ID" | "LOCATION_NAME" | "UPDATED_AT"
 ...
 */
export type CompanyContactSortKeys = "COMPANY_ID" | "CREATED_AT" | "EMAIL" | "ID" | "NAME" | "NAME_EMAIL" | "RELEVANCE" | "TITLE" | "UPDATED_AT"

/**
 * The set of valid sort keys for the CompanyLocation query.
 */
export type CompanyLocationSortKeys = "COMPANY_AND_LOCATION_NAME" | "COMPANY_ID" | "CREATED_AT" | "ID" | "NAME" | "RELEVANCE" | "UPDATED_AT"
 ...
 */
export type CompanySortKeys = "CREATED_AT" | "ID" | "NAME" | "ORDER_COUNT" | "SINCE_DATE" | "TOTAL_SPENT" | "UPDATED_AT"

/**
 * Possible error codes that can be returned by `ConsentPolicyError`.
 */
export type ConsentPolicyErrorCode = "COUNTRY_CODE_REQUIRED" | "REGION_CODE_MUST_MATCH_COUNTRY_CODE" | "REGION_CODE_REQUIRED" | "SHOPIFY_COOKIE_BANNER_NOT_DISABLED" | "UNSUPORTED_CONSENT_POLICY"
 ...
 */
export type CustomerAccountNativePagePageType = "NATIVE_ORDERS" | "NATIVE_PROFILE" | "NATIVE_SETTINGS" | "UNKNOWN"
 ...
 */
export type CustomerCancelDataErasureErrorCode = "DOES_NOT_EXIST" | "FAILED_TO_CANCEL" | "NOT_BEING_ERASED"
 ...
 */
export type CustomerEmailMarketingConsentUpdateUserErrorCode = "INCLUSION" | "INTERNAL_ERROR" | "INVALID" | "MISSING_ARGUMENT"

/**
 * The possible email marketing states for a customer.
 */
export type CustomerEmailMarketingState = "INVALID" | "NOT_SUBSCRIBED" | "PENDING" | "REDACTED" | "SUBSCRIBED" | "UNSUBSCRIBED"
 ...
 */
export type CustomerMergeErrorCode = "CUSTOMER_HAS_GIFT_CARDS" | "INTERNAL_ERROR" | "INVALID_CUSTOMER" | "INVALID_CUSTOMER_ID" | "MISSING_OVERRIDE_ATTRIBUTE" | "OVERRIDE_ATTRIBUTE_INVALID"

/**
 * The types of the hard blockers preventing a customer from being merged to another customer.
 */
export type CustomerMergeErrorFieldType = "COMPANY_CONTACT" | "CUSTOMER_PAYMENT_METHODS" | "DELETED_AT" | "GIFT_CARDS" | "MERGE_IN_PROGRESS" | "MULTIPASS_IDENTIFIER" | "PENDING_DATA_REQUEST" | "REDACTED_AT" | "STORE_CREDIT" | "SUBSCRIPTIONS"
 ...
 */
export type CustomerPaymentMethodCreateFromDuplicationDataUserErrorCode = "CUSTOMER_DOES_NOT_EXIST" | "INVALID_ENCRYPTED_DUPLICATION_DATA" | "TOO_MANY_REQUESTS"

/**
 * Possible error codes that can be returned by `CustomerPaymentMethodGetDuplicationDataUserError`.
 */
export type CustomerPaymentMethodGetDuplicationDataUserErrorCode = "CUSTOMER_DOES_NOT_EXIST" | "INVALID_INSTRUMENT" | "INVALID_ORGANIZATION_SHOP" | "PAYMENT_METHOD_DOES_NOT_EXIST" | "SAME_SHOP" | "TOO_MANY_REQUESTS"

/**
 * Possible error codes that can be returned by `CustomerPaymentMethodGetUpdateUrlUserError`.
 */
export type CustomerPaymentMethodGetUpdateUrlUserErrorCode = "CUSTOMER_DOES_NOT_EXIST" | "INVALID_INSTRUMENT" | "PAYMENT_METHOD_DOES_NOT_EXIST" | "TOO_MANY_REQUESTS"

/**
 * Possible error codes that can be returned by `CustomerPaymentMethodRemoteUserError`.
 */
export type CustomerPaymentMethodRemoteUserErrorCode = "AUTHORIZE_NET_NOT_ENABLED_FOR_SUBSCRIPTIONS" | "BRAINTREE_NOT_ENABLED_FOR_SUBSCRIPTIONS" | "EXACTLY_ONE_REMOTE_REFERENCE_REQUIRED" | "INVALID" | "PRESENT" | "TAKEN"

/**
 * The revocation reason types for a customer payment method.
 */
export type CustomerPaymentMethodRevocationReason = "AUTHORIZE_NET_GATEWAY_NOT_ENABLED" | "AUTHORIZE_NET_RETURNED_NO_PAYMENT_METHOD" | "BRAINTREE_API_AUTHENTICATION_ERROR" | "BRAINTREE_GATEWAY_NOT_ENABLED" | "BRAINTREE_PAYMENT_METHOD_NOT_CARD" | "BRAINTREE_RETURNED_NO_PAYMENT_METHOD" | "CUSTOMER_REDACTED" | "CVV_ATTEMPTS_LIMIT_EXCEEDED" | "FAILED_TO_RETRIEVE_BILLING_ADDRESS" | "FAILED_TO_UPDATE_CREDIT_CARD" | "MANUALLY_REVOKED" | "MERGED" | "PAYMENT_METHOD_VERIFICATION_FAILED" | "STRIPE_API_AUTHENTICATION_ERROR" | "STRIPE_API_INVALID_REQUEST_ERROR" | "STRIPE_GATEWAY_NOT_ENABLED" | "STRIPE_PAYMENT_METHOD_NOT_CARD" | "STRIPE_RETURNED_NO_PAYMENT_METHOD" | "THREE_D_SECURE_FLOW_IN_VERIFICATION_NOT_IMPLEMENTED" | "TOO_MANY_CONSECUTIVE_FAILURES"
 ...
 */
export type CustomerRfmGroup = "ACTIVE" | "ALMOST_LOST" | "AT_RISK" | "CHAMPIONS" | "DORMANT" | "LOYAL" | "NEEDS_ATTENTION" | "NEW" | "PREVIOUSLY_LOYAL" | "PROMISING" | "PROSPECTS"
 ...
 */
export type CustomerSetUserErrorCode = "BLANK" | "ID_NOT_ALLOWED" | "INCLUSION" | "INPUT_MISMATCH" | "INVALID" | "METAFIELD_MISMATCH" | "MISSING_FIELD_REQUIRED" | "NOT_FOUND" | "PRESENT" | "TAKEN" | "TOO_LONG" | "TOO_SHORT"

/**
 * Possible error codes that can be returned by `CustomerSmsMarketingConsentError`.
 */
export type CustomerSmsMarketingConsentErrorCode = "INCLUSION" | "INTERNAL_ERROR" | "INVALID" | "MISSING_ARGUMENT"

/**
 * The valid SMS marketing states for a customer’s phone number.
 */
export type CustomerSmsMarketingState = "NOT_SUBSCRIBED" | "PENDING" | "REDACTED" | "SUBSCRIBED" | "UNSUBSCRIBED"

/**
 * The set of valid sort keys for the Customer query.
 */
export type CustomerSortKeys = "CREATED_AT" | "ID" | "LOCATION" | "NAME" | "RELEVANCE" | "UPDATED_AT"
 ...
 */
export type DayOfTheWeek = "FRIDAY" | "MONDAY" | "SATURDAY" | "SUNDAY" | "THURSDAY" | "TUESDAY" | "WEDNESDAY"

/**
 * Possible error codes that can be returned by `DelegateAccessTokenCreateUserError`.
 */
export type DelegateAccessTokenCreateUserErrorCode = "DELEGATE_ACCESS_TOKEN" | "EMPTY_ACCESS_SCOPE" | "EXPIRES_AFTER_PARENT" | "NEGATIVE_EXPIRES_IN" | "PERSISTENCE_FAILED" | "REFRESH_TOKEN" | "UNKNOWN_SCOPES"

/**
 * Possible error codes that can be returned by `DelegateAccessTokenDestroyUserError`.
 */
export type DelegateAccessTokenDestroyUserErrorCode = "ACCESS_DENIED" | "ACCESS_TOKEN_NOT_FOUND" | "CAN_ONLY_DELETE_DELEGATE_TOKENS" | "PERSISTENCE_FAILED"
 ...
 */
export type DeliveryCustomizationErrorCode = "CUSTOM_APP_FUNCTION_NOT_ELIGIBLE" | "DELIVERY_CUSTOMIZATION_FUNCTION_NOT_ELIGIBLE" | "DELIVERY_CUSTOMIZATION_NOT_FOUND" | "FUNCTION_DOES_NOT_IMPLEMENT" | "FUNCTION_ID_CANNOT_BE_CHANGED" | "FUNCTION_NOT_FOUND" | "FUNCTION_PENDING_DELETION" | "INVALID" | "INVALID_METAFIELDS" | "MAXIMUM_ACTIVE_DELIVERY_CUSTOMIZATIONS" | "REQUIRED_INPUT_FIELD" | "UNAUTHORIZED_APP_SCOPE"
 ...
 */
export type DeliveryLocalPickupTime = "CUSTOM" | "FIVE_OR_MORE_DAYS" | "FOUR_HOURS" | "ONE_HOUR" | "TWENTY_FOUR_HOURS" | "TWO_HOURS" | "TWO_TO_FOUR_DAYS"

/**
 * Possible error codes that can be returned by `DeliveryLocationLocalPickupSettingsError`.
 */
export type DeliveryLocationLocalPickupSettingsErrorCode = "ACTIVE_LOCATION_NOT_FOUND" | "CUSTOM_PICKUP_TIME_NOT_ALLOWED" | "GENERIC_ERROR"
 ...
 */
export type DeliveryMethodType = "LOCAL" | "NONE" | "PICKUP_POINT" | "PICK_UP" | "RETAIL" | "SHIPPING"
 ...
 */
export type DeliveryPromiseProviderUpsertUserErrorCode = "INVALID_TIME_ZONE" | "MUST_BELONG_TO_APP" | "NOT_FOUND" | "TOO_LONG"
 ...
 */
export type DiscountSortKeys = "CREATED_AT" | "ENDS_AT" | "ID" | "RELEVANCE" | "STARTS_AT" | "TITLE" | "UPDATED_AT"
 ...
 */
export type DisputeEvidenceUpdateUserErrorCode = "DISPUTE_EVIDENCE_NOT_FOUND" | "EVIDENCE_ALREADY_ACCEPTED" | "EVIDENCE_PAST_DUE_DATE" | "FILES_SIZE_EXCEEDED_LIMIT" | "FILE_NOT_FOUND" | "INVALID" | "TOO_LARGE"

/**
 * The possible statuses of a dispute.
 */
export type DisputeStatus = "ACCEPTED" | "CHARGE_REFUNDED" | "LOST" | "NEEDS_RESPONSE" | "UNDER_REVIEW" | "WON"
 ...
 */
export type DraftOrderSortKeys = "CUSTOMER_NAME" | "ID" | "NUMBER" | "RELEVANCE" | "STATUS" | "TOTAL_PRICE" | "UPDATED_AT"
 ...
 */
export type ErrorsServerPixelUserErrorCode = "ALREADY_EXISTS" | "NEEDS_CONFIGURATION_TO_CONNECT" | "NOT_FOUND" | "PUB_SUB_ERROR"

/**
 * Possible error codes that can be returned by `ErrorsWebPixelUserError`.
 */
export type ErrorsWebPixelUserErrorCode = "BLANK" | "INVALID_CONFIGURATION_JSON" | "INVALID_RUNTIME_CONTEXT" | "INVALID_SETTINGS" | "INVALID_SETTINGS_DEFINITION" | "NOT_FOUND" | "NO_EXTENSION" | "TAKEN" | "UNABLE_TO_DELETE" | "UNEXPECTED_ERROR"
 ...
 */
export type EventSubjectType = "ARTICLE" | "BLOG" | "COLLECTION" | "COMMENT" | "COMPANY" | "COMPANY_LOCATION" | "CUSTOMER" | "DISCOUNT_AUTOMATIC_BXGY" | "DISCOUNT_AUTOMATIC_NODE" | "DISCOUNT_CODE_NODE" | "DISCOUNT_NODE" | "DRAFT_ORDER" | "ORDER" | "PAGE" | "PRICE_RULE" | "PRODUCT" | "PRODUCT_VARIANT" | "UNKNOWN"
 ...
 */
export type FilesErrorCode = "ALT_VALUE_LIMIT_EXCEEDED" | "BLANK_SEARCH" | "FILENAME_ALREADY_EXISTS" | "FILE_DOES_NOT_EXIST" | "FILE_LOCKED" | "INVALID" | "INVALID_DUPLICATE_MODE_FOR_TYPE" | "INVALID_FILENAME" | "INVALID_FILENAME_EXTENSION" | "INVALID_IMAGE_SOURCE_URL" | "INVALID_QUERY" | "MISMATCHED_FILENAME_AND_ORIGINAL_SOURCE" | "MISSING_ARGUMENTS" | "MISSING_FILENAME_FOR_DUPLICATE_MODE_REPLACE" | "NON_IMAGE_MEDIA_PER_SHOP_LIMIT_EXCEEDED" | "NON_READY_STATE" | "PRODUCT_MEDIA_LIMIT_EXCEEDED" | "PRODUCT_SUSPENDED" | "REFERENCE_TARGET_DOES_NOT_EXIST" | "TOO_MANY_ARGUMENTS" | "TOO_MANY_FILE_REFERENCE" | "UNACCEPTABLE_ASSET" | "UNACCEPTABLE_TRIAL_ASSET" | "UNACCEPTABLE_UNVERIFIED_TRIAL_ASSET" | "UNSUPPORTED_FILE_REFERENCE" | "UNSUPPORTED_MEDIA_TYPE_FOR_FILENAME_UPDATE"

/**
 * Possible error codes that can be returned by `FulfillmentConstraintRuleCreateUserError`.
 */
export type FulfillmentConstraintRuleCreateUserErrorCode = "CUSTOM_APP_FUNCTION_NOT_ELIGIBLE" | "FUNCTION_ALREADY_REGISTERED" | "FUNCTION_DOES_NOT_IMPLEMENT" | "FUNCTION_NOT_FOUND" | "FUNCTION_PENDING_DELETION" | "INPUT_INVALID" | "MAXIMUM_FULFILLMENT_CONSTRAINT_RULES_REACHED"
 ...
 */
export type FulfillmentDisplayStatus = "ATTEMPTED_DELIVERY" | "CANCELED" | "CONFIRMED" | "DELAYED" | "DELIVERED" | "FAILURE" | "FULFILLED" | "IN_TRANSIT" | "LABEL_PRINTED" | "LABEL_PURCHASED" | "LABEL_VOIDED" | "MARKED_AS_FULFILLED" | "NOT_DELIVERED" | "OUT_FOR_DELIVERY" | "PICKED_UP" | "READY_FOR_PICKUP" | "SUBMITTED"
 ...
 */
export type FulfillmentEventStatus = "ATTEMPTED_DELIVERY" | "CONFIRMED" | "DELAYED" | "DELIVERED" | "FAILURE" | "IN_TRANSIT" | "LABEL_PRINTED" | "LABEL_PURCHASED" | "OUT_FOR_DELIVERY" | "READY_FOR_PICKUP"

/**
 * The reason for a fulfillment hold.
 */
export type FulfillmentHoldReason = "AWAITING_PAYMENT" | "AWAITING_RETURN_ITEMS" | "HIGH_RISK_OF_FRAUD" | "INCORRECT_ADDRESS" | "INVENTORY_OUT_OF_STOCK" | "ONLINE_STORE_POST_PURCHASE_CROSS_SELL" | "OTHER" | "UNKNOWN_DELIVERY_DATE"

/**
 * The actions that can be taken on a fulfillment order.
 */
export type FulfillmentOrderAction = "CANCEL_FULFILLMENT_ORDER" | "CREATE_FULFILLMENT" | "EXTERNAL" | "HOLD" | "MARK_AS_OPEN" | "MERGE" | "MOVE" | "RELEASE_HOLD" | "REQUEST_CANCELLATION" | "REQUEST_FULFILLMENT" | "SPLIT"

/**
 * The assigment status to be used to filter fulfillment orders.
 */
export type FulfillmentOrderAssignmentStatus = "CANCELLATION_REQUESTED" | "FULFILLMENT_ACCEPTED" | "FULFILLMENT_REQUESTED" | "FULFILLMENT_UNSUBMITTED"

/**
 * Possible error codes that can be returned by `FulfillmentOrderHoldUserError`.
 */
export type FulfillmentOrderHoldUserErrorCode = "DUPLICATE_FULFILLMENT_HOLD_HANDLE" | "FULFILLMENT_ORDER_HOLD_LIMIT_REACHED" | "FULFILLMENT_ORDER_NOT_FOUND" | "FULFILLMENT_ORDER_NOT_SPLITTABLE" | "GREATER_THAN_ZERO" | "INVALID_LINE_ITEM_QUANTITY" | "TAKEN"

/**
 * Possible error codes that can be returned by `FulfillmentOrderLineItemsPreparedForPickupUserError`.
 */
export type FulfillmentOrderLineItemsPreparedForPickupUserErrorCode = "FULFILLMENT_ORDER_INVALID" | "NO_LINE_ITEMS_TO_PREPARE_FOR_FULFILLMENT_ORDER" | "UNABLE_TO_PREPARE_QUANTITY"
 ...
 */
export type FulfillmentOrderRejectionReason = "INCORRECT_ADDRESS" | "INCORRECT_PRODUCT_INFO" | "INELIGIBLE_PRODUCT" | "INTERNATIONAL_SHIPPING_UNAVAILABLE" | "INVALID_CONTACT_INFORMATION" | "INVALID_SKU" | "INVENTORY_OUT_OF_STOCK" | "MERCHANT_BLOCKED_OR_SUSPENDED" | "MISSING_CUSTOMS_INFO" | "ORDER_TOO_LARGE" | "OTHER" | "PACKAGE_PREFERENCE_NOT_SET" | "PAYMENT_DECLINED" | "UNDELIVERABLE_DESTINATION"

/**
 * Possible error codes that can be returned by `FulfillmentOrderReleaseHoldUserError`.
 */
export type FulfillmentOrderReleaseHoldUserErrorCode = "FULFILLMENT_ORDER_NOT_FOUND" | "INVALID_ACCESS"

/**
 * The request status of a fulfillment order.
 */
export type FulfillmentOrderRequestStatus = "ACCEPTED" | "CANCELLATION_ACCEPTED" | "CANCELLATION_REJECTED" | "CANCELLATION_REQUESTED" | "CLOSED" | "REJECTED" | "SUBMITTED" | "UNSUBMITTED"
 ...
 */
export type FulfillmentOrderSplitUserErrorCode = "FULFILLMENT_ORDER_NOT_FOUND" | "GREATER_THAN" | "INVALID_LINE_ITEM_QUANTITY" | "NO_LINE_ITEMS_PROVIDED_TO_SPLIT"

/**
 * The status of a fulfillment order.
 */
export type FulfillmentOrderStatus = "CANCELLED" | "CLOSED" | "INCOMPLETE" | "IN_PROGRESS" | "ON_HOLD" | "OPEN" | "SCHEDULED"
 ...
 */
export type GiftCardErrorCode = "CUSTOMER_NOT_FOUND" | "GIFT_CARD_LIMIT_EXCEEDED" | "GREATER_THAN" | "INTERNAL_ERROR" | "INVALID" | "MISSING_ARGUMENT" | "RECIPIENT_NOT_FOUND" | "TAKEN" | "TOO_LONG" | "TOO_SHORT"

/**
 * Possible error codes that can be returned by `GiftCardSendNotificationToCustomerUserError`.
 */
export type GiftCardSendNotificationToCustomerUserErrorCode = "CUSTOMER_NOT_FOUND" | "GIFT_CARD_NOT_FOUND" | "INVALID"

/**
 * Possible error codes that can be returned by `GiftCardSendNotificationToRecipientUserError`.
 */
export type GiftCardSendNotificationToRecipientUserErrorCode = "GIFT_CARD_NOT_FOUND" | "INVALID" | "RECIPIENT_NOT_FOUND"

/**
 * The set of valid sort keys for the GiftCard query.
 */
export type GiftCardSortKeys = "AMOUNT_SPENT" | "BALANCE" | "CODE" | "CREATED_AT" | "CUSTOMER_NAME" | "DISABLED_AT" | "EXPIRES_ON" | "ID" | "INITIAL_VALUE" | "UPDATED_AT"

/**
 * Possible error codes that can be returned by `GiftCardTransactionUserError`.
 */
export type GiftCardTransactionUserErrorCode = "GIFT_CARD_LIMIT_EXCEEDED" | "GIFT_CARD_NOT_FOUND" | "INSUFFICIENT_FUNDS" | "INTERNAL_ERROR" | "INVALID" | "MISMATCHING_CURRENCY" | "NEGATIVE_OR_ZERO_AMOUNT"
 ...
 * Answers the question if prices include duties and / or taxes.
 */
export type InclusiveTaxPricingStrategy = "ADD_TAXES_AT_CHECKOUT" | "INCLUDES_TAXES_IN_PRICE" | "INCLUDES_TAXES_IN_PRICE_BASED_ON_COUNTRY"

/**
 * Possible error codes that can be returned by `InventoryAdjustQuantitiesUserError`.
 */
export type InventoryAdjustQuantitiesUserErrorCode = "ADJUST_QUANTITIES_FAILED" | "INTERNAL_LEDGER_DOCUMENT" | "INVALID_AVAILABLE_DOCUMENT" | "INVALID_INVENTORY_ITEM" | "INVALID_LEDGER_DOCUMENT" | "INVALID_LOCATION" | "INVALID_QUANTITY_DOCUMENT" | "INVALID_QUANTITY_NAME" | "INVALID_QUANTITY_TOO_HIGH" | "INVALID_QUANTITY_TOO_LOW" | "INVALID_REASON" | "INVALID_REFERENCE_DOCUMENT" | "ITEM_NOT_STOCKED_AT_LOCATION" | "MAX_ONE_LEDGER_DOCUMENT" | "NON_MUTABLE_INVENTORY_ITEM"

/**
 * Possible error codes that can be returned by `InventoryBulkToggleActivationUserError`.
 */
export type InventoryBulkToggleActivationUserErrorCode = "CANNOT_DEACTIVATE_FROM_ONLY_LOCATION" | "COMMITTED_AND_INCOMING_INVENTORY_AT_LOCATION" | "COMMITTED_INVENTORY_AT_LOCATION" | "FAILED_TO_STOCK_AT_LOCATION" | "FAILED_TO_UNSTOCK_FROM_LOCATION" | "GENERIC_ERROR" | "INCOMING_INVENTORY_AT_LOCATION" | "INVENTORY_ITEM_NOT_FOUND" | "INVENTORY_MANAGED_BY_3RD_PARTY" | "INVENTORY_MANAGED_BY_SHOPIFY" | "LOCATION_NOT_FOUND" | "MISSING_SKU" | "RESERVED_INVENTORY_AT_LOCATION"

/**
 * Possible error codes that can be returned by `InventoryMoveQuantitiesUserError`.
 */
export type InventoryMoveQuantitiesUserErrorCode = "DIFFERENT_LOCATIONS" | "INTERNAL_LEDGER_DOCUMENT" | "INVALID_AVAILABLE_DOCUMENT" | "INVALID_INVENTORY_ITEM" | "INVALID_LEDGER_DOCUMENT" | "INVALID_LOCATION" | "INVALID_QUANTITY_DOCUMENT" | "INVALID_QUANTITY_NAME" | "INVALID_QUANTITY_NEGATIVE" | "INVALID_QUANTITY_TOO_HIGH" | "INVALID_REASON" | "INVALID_REFERENCE_DOCUMENT" | "ITEM_NOT_STOCKED_AT_LOCATION" | "MAXIMUM_LEDGER_DOCUMENT_URIS" | "MOVE_QUANTITIES_FAILED" | "NON_MUTABLE_INVENTORY_ITEM" | "SAME_QUANTITY_NAME"

/**
 * Possible error codes that can be returned by `InventorySetOnHandQuantitiesUserError`.
 */
export type InventorySetOnHandQuantitiesUserErrorCode = "INVALID_INVENTORY_ITEM" | "INVALID_LOCATION" | "INVALID_QUANTITY_NEGATIVE" | "INVALID_QUANTITY_TOO_HIGH" | "INVALID_REASON" | "INVALID_REFERENCE_DOCUMENT" | "ITEM_NOT_STOCKED_AT_LOCATION" | "NON_MUTABLE_INVENTORY_ITEM" | "SET_ON_HAND_QUANTITIES_FAILED"

/**
 * Possible error codes that can be returned by `InventorySetQuantitiesUserError`.
 */
export type InventorySetQuantitiesUserErrorCode = "COMPARE_QUANTITY_REQUIRED" | "COMPARE_QUANTITY_STALE" | "INVALID_INVENTORY_ITEM" | "INVALID_LOCATION" | "INVALID_NAME" | "INVALID_QUANTITY_NEGATIVE" | "INVALID_QUANTITY_TOO_HIGH" | "INVALID_QUANTITY_TOO_LOW" | "INVALID_REASON" | "INVALID_REFERENCE_DOCUMENT" | "ITEM_NOT_STOCKED_AT_LOCATION" | "NON_MUTABLE_INVENTORY_ITEM" | "NO_DUPLICATE_INVENTORY_ITEM_ID_GROUP_ID_PAIR"

/**
 * Possible error codes that can be returned by `InventorySetScheduledChangesUserError`.
 */
export type InventorySetScheduledChangesUserErrorCode = "DUPLICATE_FROM_NAME" | "DUPLICATE_TO_NAME" | "ERROR_UPDATING_SCHEDULED" | "INCLUSION" | "INVALID_FROM_NAME" | "INVALID_REASON" | "INVALID_TO_NAME" | "INVENTORY_ITEM_NOT_FOUND" | "INVENTORY_STATE_NOT_FOUND" | "ITEMS_EMPTY" | "LEDGER_DOCUMENT_INVALID" | "LOCATION_NOT_FOUND" | "SAME_FROM_TO_NAMES"

/**
 * Language codes supported by Shopify.
 */
export type LanguageCode = "AF" | "AK" | "AM" | "AR" | "AS" | "AZ" | "BE" | "BG" | "BM" | "BN" | "BO" | "BR" | "BS" | "CA" | "CE" | "CKB" | "CS" | "CU" | "CY" | "DA" | "DE" | "DZ" | "EE" | "EL" | "EN" | "EO" | "ES" | "ET" | "EU" | "FA" | "FF" | "FI" | "FIL" | "FO" | "FR" | "FY" | "GA" | "GD" | "GL" | "GU" | "GV" | "HA" | "HE" | "HI" | "HR" | "HU" | "HY" | "IA" | "ID" | "IG" | "II" | "IS" | "IT" | "JA" | "JV" | "KA" | "KI" | "KK" | "KL" | "KM" | "KN" | "KO" | "KS" | "KU" | "KW" | "KY" | "LB" | "LG" | "LN" | "LO" | "LT" | "LU" | "LV" | "MG" | "MI" | "MK" | "ML" | "MN" | "MR" | "MS" | "MT" | "MY" | "NB" | "ND" | "NE" | "NL" | "NN" | "NO" | "OM" | "OR" | "OS" | "PA" | "PL" | "PS" | "PT" | "PT_BR" | "PT_PT" | "QU" | "RM" | "RN" | "RO" | "RU" | "RW" | "SA" | "SC" | "SD" | "SE" | "SG" | "SI" | "SK" | "SL" | "SN" | "SO" | "SQ" | "SR" | "SU" | "SV" | "SW" | "TA" | "TE" | "TG" | "TH" | "TI" | "TK" | "TO" | "TR" | "TT" | "UG" | "UK" | "UR" | "UZ" | "VI" | "VO" | "WO" | "XH" | "YI" | "YO" | "ZH" | "ZH_CN" | "ZH_TW" | "ZU"
 ...
 */
export type LocalizableContentType = "FILE_REFERENCE" | "HTML" | "INLINE_RICH_TEXT" | "JSON" | "JSON_STRING" | "LINK" | "LIST_FILE_REFERENCE" | "LIST_LINK" | "LIST_MULTI_LINE_TEXT_FIELD" | "LIST_SINGLE_LINE_TEXT_FIELD" | "LIST_URL" | "MULTI_LINE_TEXT_FIELD" | "RICH_TEXT_FIELD" | "SINGLE_LINE_TEXT_FIELD" | "STRING" | "URI" | "URL"

/**
 * The key of a localization extension.
 */
export type LocalizationExtensionKey = "SHIPPING_CREDENTIAL_BR" | "SHIPPING_CREDENTIAL_CL" | "SHIPPING_CREDENTIAL_CN" | "SHIPPING_CREDENTIAL_CO" | "SHIPPING_CREDENTIAL_CR" | "SHIPPING_CREDENTIAL_EC" | "SHIPPING_CREDENTIAL_ES" | "SHIPPING_CREDENTIAL_GT" | "SHIPPING_CREDENTIAL_ID" | "SHIPPING_CREDENTIAL_KR" | "SHIPPING_CREDENTIAL_MX" | "SHIPPING_CREDENTIAL_MY" | "SHIPPING_CREDENTIAL_PE" | "SHIPPING_CREDENTIAL_PT" | "SHIPPING_CREDENTIAL_PY" | "SHIPPING_CREDENTIAL_TR" | "SHIPPING_CREDENTIAL_TW" | "SHIPPING_CREDENTIAL_TYPE_CO" | "TAX_CREDENTIAL_BR" | "TAX_CREDENTIAL_CL" | "TAX_CREDENTIAL_CO" | "TAX_CREDENTIAL_CR" | "TAX_CREDENTIAL_EC" | "TAX_CREDENTIAL_ES" | "TAX_CREDENTIAL_GT" | "TAX_CREDENTIAL_ID" | "TAX_CREDENTIAL_IT" | "TAX_CREDENTIAL_MX" | "TAX_CREDENTIAL_MY" | "TAX_CREDENTIAL_PE" | "TAX_CREDENTIAL_PT" | "TAX_CREDENTIAL_PY" | "TAX_CREDENTIAL_TR" | "TAX_CREDENTIAL_TYPE_CO" | "TAX_CREDENTIAL_TYPE_MX" | "TAX_CREDENTIAL_USE_MX" | "TAX_EMAIL_IT"
 ...
 */
export type LocalizedFieldKey = "SHIPPING_CREDENTIAL_BR" | "SHIPPING_CREDENTIAL_CL" | "SHIPPING_CREDENTIAL_CN" | "SHIPPING_CREDENTIAL_CO" | "SHIPPING_CREDENTIAL_CR" | "SHIPPING_CREDENTIAL_EC" | "SHIPPING_CREDENTIAL_ES" | "SHIPPING_CREDENTIAL_GT" | "SHIPPING_CREDENTIAL_ID" | "SHIPPING_CREDENTIAL_KR" | "SHIPPING_CREDENTIAL_MX" | "SHIPPING_CREDENTIAL_MY" | "SHIPPING_CREDENTIAL_PE" | "SHIPPING_CREDENTIAL_PT" | "SHIPPING_CREDENTIAL_PY" | "SHIPPING_CREDENTIAL_TR" | "SHIPPING_CREDENTIAL_TW" | "SHIPPING_CREDENTIAL_TYPE_CO" | "TAX_CREDENTIAL_BR" | "TAX_CREDENTIAL_CL" | "TAX_CREDENTIAL_CO" | "TAX_CREDENTIAL_CR" | "TAX_CREDENTIAL_EC" | "TAX_CREDENTIAL_ES" | "TAX_CREDENTIAL_GT" | "TAX_CREDENTIAL_ID" | "TAX_CREDENTIAL_IT" | "TAX_CREDENTIAL_MX" | "TAX_CREDENTIAL_MY" | "TAX_CREDENTIAL_PE" | "TAX_CREDENTIAL_PT" | "TAX_CREDENTIAL_PY" | "TAX_CREDENTIAL_TR" | "TAX_CREDENTIAL_TYPE_CO" | "TAX_CREDENTIAL_TYPE_MX" | "TAX_CREDENTIAL_USE_MX" | "TAX_EMAIL_IT"
 ...
 */
export type LocationActivateUserErrorCode = "GENERIC_ERROR" | "HAS_NON_UNIQUE_NAME" | "HAS_ONGOING_RELOCATION" | "LOCATION_LIMIT" | "LOCATION_NOT_FOUND"

/**
 * Possible error codes that can be returned by `LocationAddUserError`.
 */
export type LocationAddUserErrorCode = "APP_NOT_AUTHORIZED" | "BLANK" | "CAPABILITY_VIOLATION" | "DISALLOWED_OWNER_TYPE" | "GENERIC_ERROR" | "INCLUSION" | "INTERNAL_ERROR" | "INVALID" | "INVALID_TYPE" | "INVALID_US_ZIPCODE" | "INVALID_VALUE" | "PRESENT" | "TAKEN" | "TOO_LONG" | "TOO_SHORT" | "UNSTRUCTURED_RESERVED_NAMESPACE"

/**
 * Possible error codes that can be returned by `LocationDeactivateUserError`.
 */
export type LocationDeactivateUserErrorCode = "CANNOT_DISABLE_ONLINE_ORDER_FULFILLMENT" | "DESTINATION_LOCATION_IS_THE_SAME_LOCATION" | "DESTINATION_LOCATION_NOT_FOUND_OR_INACTIVE" | "FAILED_TO_RELOCATE_ACTIVE_INVENTORIES" | "FAILED_TO_RELOCATE_INCOMING_MOVEMENTS" | "FAILED_TO_RELOCATE_OPEN_PURCHASE_ORDERS" | "HAS_ACTIVE_INVENTORY_ERROR" | "HAS_ACTIVE_RETAIL_SUBSCRIPTIONS" | "HAS_FULFILLMENT_ORDERS_ERROR" | "HAS_INCOMING_MOVEMENTS_ERROR" | "HAS_OPEN_PURCHASE_ORDERS_ERROR" | "LOCATION_NOT_FOUND" | "PERMANENTLY_BLOCKED_FROM_DEACTIVATION_ERROR" | "TEMPORARILY_BLOCKED_FROM_DEACTIVATION_ERROR"

/**
 * Possible error codes that can be returned by `LocationDeleteUserError`.
 */
export type LocationDeleteUserErrorCode = "GENERIC_ERROR" | "LOCATION_HAS_ACTIVE_RETAIL_SUBSCRIPTION" | "LOCATION_HAS_INVENTORY" | "LOCATION_HAS_PENDING_ORDERS" | "LOCATION_IS_ACTIVE" | "LOCATION_NOT_FOUND"

/**
 * Possible error codes that can be returned by `LocationEditUserError`.
 */
export type LocationEditUserErrorCode = "APP_NOT_AUTHORIZED" | "BLANK" | "CANNOT_DISABLE_ONLINE_ORDER_FULFILLMENT" | "CANNOT_MODIFY_ONLINE_ORDER_FULFILLMENT_FOR_FS_LOCATION" | "CAPABILITY_VIOLATION" | "DISALLOWED_OWNER_TYPE" | "GENERIC_ERROR" | "INCLUSION" | "INTERNAL_ERROR" | "INVALID" | "INVALID_TYPE" | "INVALID_US_ZIPCODE" | "INVALID_VALUE" | "NOT_FOUND" | "PRESENT" | "TAKEN" | "TOO_LONG" | "TOO_SHORT" | "UNSTRUCTURED_RESERVED_NAMESPACE"
 ...
 */
export type MarketCurrencySettingsUserErrorCode = "MANAGED_MARKET" | "MARKET_NOT_FOUND" | "MULTIPLE_CURRENCIES_NOT_SUPPORTED" | "NO_LOCAL_CURRENCIES_ON_SINGLE_COUNTRY_MARKET" | "PRIMARY_MARKET_USES_SHOP_CURRENCY" | "UNIFIED_MARKETS_ENABLED" | "UNSUPPORTED_CURRENCY"
 ...
 */
export type MarketUserErrorCode = "B2B_MARKET_MUST_BE_MERCHANT_MANAGED" | "BLANK" | "CANNOT_ADD_CUSTOMER_DOMAIN" | "CANNOT_ADD_REGIONS_TO_PRIMARY_MARKET" | "CANNOT_ADD_WEB_PRESENCE_TO_PRIMARY_MARKET" | "CANNOT_DELETE_ONLY_REGION" | "CANNOT_DELETE_PRIMARY_MARKET" | "CANNOT_DELETE_PRIMARY_MARKET_WEB_PRESENCE" | "CANNOT_DISABLE_PRIMARY_MARKET" | "CANNOT_HAVE_BOTH_SUBFOLDER_AND_DOMAIN_WEB_PRESENCES" | "CANNOT_HAVE_MULTIPLE_SUBFOLDERS_PER_MARKET" | "CANNOT_HAVE_SUBFOLDER_AND_DOMAIN" | "CANNOT_SET_DEFAULT_LOCALE_TO_NULL" | "CATALOGS_WITH_VOLUME_PRICING_OR_QUANTITY_RULES_NOT_SUPPORTED" | "CATALOG_CONDITION_TYPES_MUST_BE_THE_SAME" | "CATALOG_NOT_COMPATIBLE_WITH_CONDITION_TYPES" | "CATALOG_TYPE_NOT_SUPPORTED" | "CONDITIONS_NOT_FOUND" | "CONTAINS_REGIONS_THAT_CANNOT_BE_MANAGED" | "CUSTOMIZATIONS_NOT_FOUND" | "DISABLED_LANGUAGE" | "DOMAIN_NOT_FOUND" | "DUPLICATE_LANGUAGES" | "DUPLICATE_REGION_MARKET" | "DUPLICATE_UNIQUE_MARKET" | "EXCEEDS_MAX_MULTI_CONTEXT_MARKETS" | "GENERIC_ERROR" | "INCLUSION" | "INCLUSIVE_PRICING_NOT_COMPATIBLE_WITH_CONDITION_TYPES" | "INCOMPATIBLE_CONDITIONS" | "INVALID" | "INVALID_STATUS_AND_ENABLED_COMBINATION" | "LOCATION_MATCH_ALL_REQUIRES_ONE_SPECIFIC_REGION" | "LOCATION_REGION_COUNTRY_MISMATCH" | "MANAGED_MARKET" | "MANAGED_MARKETS_CATALOG_NOT_ALLOWED" | "MARKET_CANT_HAVE_DIRECT_CONNECTION_CATALOG" | "MARKET_NOT_FOUND" | "MARKET_REACHED_WEB_PRESENCE_LIMIT" | "MIXED_COUNTRY_LOCATIONS_NOT_ALLOWED" | "MULTIPLE_CURRENCIES_NOT_SUPPORTED" | "MUST_HAVE_AT_LEAST_ONE_ACTIVE_REGION_MARKET" | "NO_LANGUAGES" | "NO_LOCAL_CURRENCIES_ON_SINGLE_COUNTRY_MARKET" | "NO_ROUNDING_ON_LEGACY_MARKET" | "POS_LOCATION_MARKET_MUST_BE_MERCHANT_MANAGED" | "PRIMARY_MARKET_MUST_USE_PRIMARY_DOMAIN" | "REGION_NOT_FOUND" | "REGION_SPECIFIC_LANGUAGE" | "REQUIRES_DOMAIN_OR_SUBFOLDER" | "REQUIRES_EXACTLY_ONE_OPTION" | "RETAIL_LOCATION_CURRENCY_MUST_BE_LOCAL" | "SHOP_MUST_HAVE_PRIMARY_DOMAIN_WEB_PRESENCE" | "SHOP_REACHED_MARKETS_LIMIT" | "SPECIFIED_NOT_VALID_FOR_INPUT" | "SUBFOLDER_SUFFIX_CANNOT_BE_SCRIPT_CODE" | "SUBFOLDER_SUFFIX_MUST_CONTAIN_ONLY_LETTERS" | "TAKEN" | "TOO_LONG" | "TOO_SHORT" | "UNIFIED_MARKETS_NOT_ENABLED" | "UNPUBLISHED_LANGUAGE" | "UNSUPPORTED_COUNTRY_REGION" | "UNSUPPORTED_CURRENCY" | "USER_LACKS_PERMISSION" | "WEB_PRESENCE_NOT_COMPATIBLE_WITH_CONDITION_TYPES" | "WEB_PRESENCE_NOT_FOUND" | "WEB_PRESENCE_REACHED_MARKETS_LIMIT" | "WILDCARD_NOT_SUPPORTED"

/**
 * The error code resulted from the marketing activity extension integration.
 */
export type MarketingActivityExtensionAppErrorCode = "API_ERROR" | "INSTALL_REQUIRED_ERROR" | "NOT_ONBOARDED_ERROR" | "PLATFORM_ERROR" | "VALIDATION_ERROR"

/**
 * Set of possible statuses for an external marketing activity.
 */
export type MarketingActivityExternalStatus = "ACTIVE" | "DELETED_EXTERNALLY" | "INACTIVE" | "PAUSED" | "SCHEDULED" | "UNDEFINED"
 ...
 */
export type MarketingActivityStatusBadgeType = "ATTENTION" | "CRITICAL" | "DEFAULT" | "INFO" | "SUCCESS" | "WARNING"

/**
 * Possible error codes that can be returned by `MarketingActivityUserError`.
 */
export type MarketingActivityUserErrorCode = "ACTIVITY_NOT_EXTERNAL" | "CANNOT_DELETE_ACTIVITY_WITH_CHILD_EVENTS" | "CANNOT_UPDATE_TACTIC_IF_ORIGINALLY_STOREFRONT_APP" | "CANNOT_UPDATE_TACTIC_TO_STOREFRONT_APP" | "CURRENCY_CODE_MISMATCH_INPUT" | "DELETE_JOB_ENQUEUED" | "DELETE_JOB_FAILED_TO_ENQUEUE" | "IMMUTABLE_CHANNEL_HANDLE" | "IMMUTABLE_HIERARCHY_LEVEL" | "IMMUTABLE_PARENT_ID" | "IMMUTABLE_URL_PARAMETER" | "IMMUTABLE_UTM_PARAMETERS" | "INVALID" | "INVALID_CHANNEL_HANDLE" | "INVALID_DELETE_ACTIVITY_EXTERNAL_ARGUMENTS" | "INVALID_DELETE_ENGAGEMENTS_ARGUMENTS" | "INVALID_MARKETING_ACTIVITY_EXTERNAL_ARGUMENTS" | "INVALID_MARKETING_ENGAGEMENT_ARGUMENTS" | "INVALID_MARKETING_ENGAGEMENT_ARGUMENT_MISSING" | "INVALID_REMOTE_ID" | "MARKETING_ACTIVITY_CURRENCY_CODE_MISMATCH" | "MARKETING_ACTIVITY_DOES_NOT_EXIST" | "MARKETING_EVENT_DOES_NOT_EXIST" | "NON_HIERARCHIAL_REQUIRES_UTM_URL_PARAMETER" | "TAKEN"
 ...
 */
export type MarketingTactic = "ABANDONED_CART" | "AD" | "AFFILIATE" | "LINK" | "LOYALTY" | "MESSAGE" | "NEWSLETTER" | "NOTIFICATION" | "POST" | "RETARGETING" | "SEO" | "STOREFRONT_APP" | "TRANSACTIONAL"

/**
 * The set of valid sort keys for the Markets query.
 */
export type MarketsSortKeys = "CREATED_AT" | "ID" | "MARKET_CONDITION_TYPES" | "MARKET_TYPE" | "NAME" | "UPDATED_AT"
 ...
 */
export type MediaErrorCode = "DUPLICATE_FILENAME_ERROR" | "EXTERNAL_VIDEO_EMBED_DISABLED" | "EXTERNAL_VIDEO_EMBED_NOT_FOUND_OR_TRANSCODING" | "EXTERNAL_VIDEO_INVALID_ASPECT_RATIO" | "EXTERNAL_VIDEO_NOT_FOUND" | "EXTERNAL_VIDEO_UNLISTED" | "FILE_STORAGE_LIMIT_EXCEEDED" | "GENERIC_FILE_DOWNLOAD_FAILURE" | "GENERIC_FILE_INVALID_SIZE" | "IMAGE_DOWNLOAD_FAILURE" | "IMAGE_PROCESSING_FAILURE" | "INVALID_IMAGE_ASPECT_RATIO" | "INVALID_IMAGE_FILE_SIZE" | "INVALID_IMAGE_RESOLUTION" | "INVALID_SIGNED_URL" | "MEDIA_TIMEOUT_ERROR" | "MODEL3D_GLB_OUTPUT_CREATION_ERROR" | "MODEL3D_GLB_TO_USDZ_CONVERSION_ERROR" | "MODEL3D_PROCESSING_FAILURE" | "MODEL3D_THUMBNAIL_GENERATION_ERROR" | "MODEL3D_THUMBNAIL_REGENERATION_ERROR" | "MODEL3D_VALIDATION_ERROR" | "UNKNOWN" | "UNSUPPORTED_IMAGE_FILE_TYPE" | "VIDEO_INVALID_FILETYPE_ERROR" | "VIDEO_MAX_DURATION_ERROR" | "VIDEO_MAX_HEIGHT_ERROR" | "VIDEO_MAX_WIDTH_ERROR" | "VIDEO_METADATA_READ_ERROR" | "VIDEO_MIN_DURATION_ERROR" | "VIDEO_MIN_HEIGHT_ERROR" | "VIDEO_MIN_WIDTH_ERROR" | "VIDEO_VALIDATION_ERROR"
 ...
 */
export type MediaUserErrorCode = "BLANK" | "INVALID" | "INVALID_MEDIA_TYPE" | "MAXIMUM_VARIANT_MEDIA_PAIRS_EXCEEDED" | "MEDIA_CANNOT_BE_MODIFIED" | "MEDIA_DOES_NOT_EXIST" | "MEDIA_DOES_NOT_EXIST_ON_PRODUCT" | "MEDIA_IS_NOT_ATTACHED_TO_VARIANT" | "MISSING_ARGUMENTS" | "MODEL3D_THROTTLE_EXCEEDED" | "MODEL3D_VALIDATION_ERROR" | "NON_READY_MEDIA" | "PRODUCT_DOES_NOT_EXIST" | "PRODUCT_MEDIA_LIMIT_EXCEEDED" | "PRODUCT_SUSPENDED" | "PRODUCT_VARIANT_ALREADY_HAS_MEDIA" | "PRODUCT_VARIANT_DOES_NOT_EXIST_ON_PRODUCT" | "PRODUCT_VARIANT_SPECIFIED_MULTIPLE_TIMES" | "SHOP_MEDIA_LIMIT_EXCEEDED" | "TOO_MANY_MEDIA_PER_INPUT_PAIR" | "VIDEO_THROTTLE_EXCEEDED" | "VIDEO_VALIDATION_ERROR"
 ...
 * A menu item type.
 */
export type MenuItemType = "ARTICLE" | "BLOG" | "CATALOG" | "COLLECTION" | "COLLECTIONS" | "CUSTOMER_ACCOUNT_PAGE" | "FRONTPAGE" | "HTTP" | "METAOBJECT" | "PAGE" | "PRODUCT" | "SEARCH" | "SHOP_POLICY"
 ...
 */
export type MetafieldAdminAccess = "MERCHANT_READ" | "MERCHANT_READ_WRITE" | "PRIVATE" | "PUBLIC_READ" | "PUBLIC_READ_WRITE"
 ...
 */
export type MetafieldDefinitionAdminFilterStatus = "FAILED" | "FILTERABLE" | "IN_PROGRESS" | "NOT_FILTERABLE"

/**
 * Metafield definition constraint criteria to filter metafield definitions by.
 */
export type MetafieldDefinitionConstraintStatus = "CONSTRAINED_AND_UNCONSTRAINED" | "CONSTRAINED_ONLY" | "UNCONSTRAINED_ONLY"

/**
 * Possible error codes that can be returned by `MetafieldDefinitionCreateUserError`.
 */
export type MetafieldDefinitionCreateUserErrorCode = "ADMIN_ACCESS_INPUT_NOT_ALLOWED" | "BLANK" | "CAPABILITY_REQUIRED_BUT_DISABLED" | "DUPLICATE_OPTION" | "GRANT_LIMIT_EXCEEDED" | "INCLUSION" | "INVALID" | "INVALID_CAPABILITY" | "INVALID_CHARACTER" | "INVALID_CONSTRAINTS" | "INVALID_INPUT_COMBINATION" | "INVALID_OPTION" | "LIMIT_EXCEEDED" | "OWNER_TYPE_LIMIT_EXCEEDED_FOR_AUTOMATED_COLLECTIONS" | "PINNED_LIMIT_REACHED" | "PRESENT" | "RESERVED_NAMESPACE_KEY" | "RESOURCE_TYPE_LIMIT_EXCEEDED" | "TAKEN" | "TOO_LONG" | "TOO_SHORT" | "TYPE_NOT_ALLOWED_FOR_CONDITIONS" | "UNSTRUCTURED_ALREADY_EXISTS" | "UNSUPPORTED_PINNING"

/**
 * Possible error codes that can be returned by `MetafieldDefinitionDeleteUserError`.
 */
export type MetafieldDefinitionDeleteUserErrorCode = "APP_CONFIG_MANAGED" | "DISALLOWED_OWNER_TYPE" | "ID_TYPE_DELETION_ERROR" | "INTERNAL_ERROR" | "METAFIELD_DEFINITION_IN_USE" | "NOT_FOUND" | "PRESENT" | "REFERENCE_TYPE_DELETION_ERROR" | "RESERVED_NAMESPACE_ORPHANED_METAFIELDS"

/**
 * Possible error codes that can be returned by `MetafieldDefinitionPinUserError`.
 */
export type MetafieldDefinitionPinUserErrorCode = "ALREADY_PINNED" | "DISALLOWED_OWNER_TYPE" | "INTERNAL_ERROR" | "NOT_FOUND" | "PINNED_LIMIT_REACHED" | "UNSUPPORTED_PINNING"
 ...
 */
export type MetafieldDefinitionUnpinUserErrorCode = "APP_CONFIG_MANAGED" | "DISALLOWED_OWNER_TYPE" | "INTERNAL_ERROR" | "NOT_FOUND" | "NOT_PINNED"

/**
 * Possible error codes that can be returned by `MetafieldDefinitionUpdateUserError`.
 */
export type MetafieldDefinitionUpdateUserErrorCode = "ADMIN_ACCESS_INPUT_NOT_ALLOWED" | "APP_CONFIG_MANAGED" | "BLANK" | "CAPABILITY_CANNOT_BE_DISABLED" | "CAPABILITY_REQUIRED_BUT_DISABLED" | "DISALLOWED_OWNER_TYPE" | "GRANT_LIMIT_EXCEEDED" | "INTERNAL_ERROR" | "INVALID_CAPABILITY" | "INVALID_CONSTRAINTS" | "INVALID_INPUT" | "INVALID_INPUT_COMBINATION" | "METAFIELD_DEFINITION_IN_USE" | "METAOBJECT_DEFINITION_CHANGED" | "NOT_FOUND" | "OWNER_TYPE_LIMIT_EXCEEDED_FOR_AUTOMATED_COLLECTIONS" | "PINNED_LIMIT_REACHED" | "PRESENT" | "TOO_LONG" | "TYPE_NOT_ALLOWED_FOR_CONDITIONS" | "UNSUPPORTED_PINNING"
 ...
 */
export type MetafieldsSetUserErrorCode = "APP_NOT_AUTHORIZED" | "BLANK" | "CAPABILITY_VIOLATION" | "INCLUSION" | "INTERNAL_ERROR" | "INVALID_COMPARE_DIGEST" | "INVALID_TYPE" | "INVALID_VALUE" | "LESS_THAN_OR_EQUAL_TO" | "PRESENT" | "STALE_OBJECT" | "TAKEN" | "TOO_LONG" | "TOO_SHORT"

/**
 * Metaobject access permissions for the Admin API. When the metaobject is app-owned, the owning app always has
 * full access.
 */
export type MetaobjectAdminAccess = "MERCHANT_READ" | "MERCHANT_READ_WRITE" | "PRIVATE" | "PUBLIC_READ" | "PUBLIC_READ_WRITE"
 ...
 */
export type MetaobjectCapabilityType = "ONLINE_STORE" | "PUBLISHABLE" | "RENDERABLE" | "TRANSLATABLE"
 ...
 */
export type MetaobjectUserErrorCode = "ADMIN_ACCESS_INPUT_NOT_ALLOWED" | "APP_CONFIG_MANAGED" | "BLANK" | "CAPABILITY_NOT_ENABLED" | "DISPLAY_NAME_CONFLICT" | "DUPLICATE_FIELD_INPUT" | "FIELD_TYPE_INVALID" | "IMMUTABLE" | "INCLUSION" | "INPUT_LIMIT_EXCEEDED" | "INTERNAL_ERROR" | "INVALID" | "INVALID_OPTION" | "INVALID_TYPE" | "INVALID_VALUE" | "MAX_DEFINITIONS_EXCEEDED" | "MAX_OBJECTS_EXCEEDED" | "MISSING_REQUIRED_KEYS" | "NOT_AUTHORIZED" | "OBJECT_FIELD_REQUIRED" | "OBJECT_FIELD_TAKEN" | "PRESENT" | "RECORD_NOT_FOUND" | "REFERENCE_EXISTS_ERROR" | "RESERVED_NAME" | "TAKEN" | "TOO_LONG" | "TOO_SHORT" | "UNDEFINED_OBJECT_FIELD" | "UNDEFINED_OBJECT_TYPE" | "URL_HANDLE_BLANK" | "URL_HANDLE_INVALID" | "URL_HANDLE_TAKEN"
 ...
 */
export type OnlineStoreThemeFileResultType = "BAD_REQUEST" | "CONFLICT" | "ERROR" | "NOT_FOUND" | "SUCCESS" | "TIMEOUT" | "UNPROCESSABLE_ENTITY"

/**
 * Possible error codes that can be returned by `OnlineStoreThemeFilesUserErrors`.
 */
export type OnlineStoreThemeFilesUserErrorsCode = "ACCESS_DENIED" | "DUPLICATE_FILE_INPUT" | "ERROR" | "FILE_VALIDATION_ERROR" | "LESS_THAN_OR_EQUAL_TO" | "NOT_FOUND" | "THEME_FILES_CONFLICT" | "THEME_LIMITED_PLAN" | "THROTTLED"
 ...
 */
export type OrderAdjustmentDiscrepancyReason = "CUSTOMER" | "DAMAGE" | "FULL_RETURN_BALANCING_ADJUSTMENT" | "PENDING_REFUND_DISCREPANCY" | "REFUND_DISCREPANCY" | "RESTOCK"
 ...
 */
export type OrderCreateFinancialStatus = "AUTHORIZED" | "EXPIRED" | "PAID" | "PARTIALLY_PAID" | "PARTIALLY_REFUNDED" | "PENDING" | "REFUNDED" | "VOIDED"
 ...
 */
export type OrderCreateInputsInventoryBehavior = "BYPASS" | "DECREMENT_IGNORING_POLICY" | "DECREMENT_OBEYING_POLICY"
 ...
 */
export type OrderCreateManualPaymentOrderCreateManualPaymentErrorCode = "AMOUNT_EXCEEDS_BALANCE" | "AMOUNT_NOT_POSITIVE" | "GATEWAY_NOT_FOUND" | "ORDER_IS_TEMPORARILY_UNAVAILABLE" | "ORDER_NOT_FOUND"

/**
 * Possible error codes that can be returned by `OrderCreateUserError`.
 */
export type OrderCreateUserErrorCode = "FULFILLMENT_SERVICE_INVALID" | "INVALID" | "INVENTORY_CLAIM_FAILED" | "PROCESSED_AT_INVALID" | "REDUNDANT_CUSTOMER_FIELDS" | "SHOP_DORMANT" | "TAX_LINE_RATE_MISSING"
 ...
 */
export type OrderDisplayFinancialStatus = "AUTHORIZED" | "EXPIRED" | "PAID" | "PARTIALLY_PAID" | "PARTIALLY_REFUNDED" | "PENDING" | "REFUNDED" | "VOIDED"

/**
 * Represents the order's aggregated fulfillment status for display purposes.
 */
export type OrderDisplayFulfillmentStatus = "FULFILLED" | "IN_PROGRESS" | "ON_HOLD" | "OPEN" | "PARTIALLY_FULFILLED" | "PENDING_FULFILLMENT" | "REQUEST_DECLINED" | "RESTOCKED" | "SCHEDULED" | "UNFULFILLED"
 ...
 */
export type OrderPaymentStatusResult = "AUTHORIZED" | "CAPTURED" | "ERROR" | "INITIATED" | "PENDING" | "PROCESSING" | "PURCHASED" | "REDIRECT_REQUIRED" | "REFUNDED" | "RETRYABLE" | "SUCCESS" | "UNKNOWN" | "VOIDED"
 ...
 */
export type OrderReturnStatus = "INSPECTION_COMPLETE" | "IN_PROGRESS" | "NO_RETURN" | "RETURNED" | "RETURN_FAILED" | "RETURN_REQUESTED"

/**
 * Possible error codes that can be returned by `OrderRiskAssessmentCreateUserError`.
 */
export type OrderRiskAssessmentCreateUserErrorCode = "INVALID" | "NOT_FOUND" | "ORDER_ALREADY_FULFILLED" | "TOO_MANY_FACTS"
 ...
 */
export type OrderSortKeys = "CREATED_AT" | "CUSTOMER_NAME" | "DESTINATION" | "FINANCIAL_STATUS" | "FULFILLMENT_STATUS" | "ID" | "ORDER_NUMBER" | "PO_NUMBER" | "PROCESSED_AT" | "RELEVANCE" | "TOTAL_ITEMS_QUANTITY" | "TOTAL_PRICE" | "UPDATED_AT"

/**
 * A standardized error code, independent of the payment provider.
 */
export type OrderTransactionErrorCode = "AMAZON_PAYMENTS_INVALID_PAYMENT_METHOD" | "AMAZON_PAYMENTS_MAX_AMOUNT_CHARGED" | "AMAZON_PAYMENTS_MAX_AMOUNT_REFUNDED" | "AMAZON_PAYMENTS_MAX_AUTHORIZATIONS_CAPTURED" | "AMAZON_PAYMENTS_MAX_REFUNDS_PROCESSED" | "AMAZON_PAYMENTS_ORDER_REFERENCE_CANCELED" | "AMAZON_PAYMENTS_STALE" | "CALL_ISSUER" | "CARD_DECLINED" | "CONFIG_ERROR" | "EXPIRED_CARD" | "GENERIC_ERROR" | "INCORRECT_ADDRESS" | "INCORRECT_CVC" | "INCORRECT_NUMBER" | "INCORRECT_PIN" | "INCORRECT_ZIP" | "INVALID_AMOUNT" | "INVALID_COUNTRY" | "INVALID_CVC" | "INVALID_EXPIRY_DATE" | "INVALID_NUMBER" | "PAYMENT_METHOD_UNAVAILABLE" | "PICK_UP_CARD" | "PROCESSING_ERROR" | "TEST_MODE_LIVE_CARD" | "UNSUPPORTED_FEATURE"

/**
 * The different kinds of order transactions.
 */
export type OrderTransactionKind = "AUTHORIZATION" | "CAPTURE" | "CHANGE" | "EMV_AUTHORIZATION" | "REFUND" | "SALE" | "SUGGESTED_REFUND" | "VOID"

/**
 * The different states that an `OrderTransaction` can have.
 */
export type OrderTransactionStatus = "AWAITING_RESPONSE" | "ERROR" | "FAILURE" | "PENDING" | "SUCCESS" | "UNKNOWN"

/**
 * Possible error codes that can be returned by `PageCreateUserError`.
 */
export type PageCreateUserErrorCode = "BLANK" | "INVALID_PUBLISH_DATE" | "INVALID_TYPE" | "INVALID_VALUE" | "TAKEN" | "TOO_LONG"
 ...
 */
export type PageUpdateUserErrorCode = "BLANK" | "INVALID_PUBLISH_DATE" | "NOT_FOUND" | "TAKEN" | "TOO_LONG"

/**
 * Possible error codes that can be returned by `PaymentCustomizationError`.
 */
export type PaymentCustomizationErrorCode = "CUSTOM_APP_FUNCTION_NOT_ELIGIBLE" | "FUNCTION_DOES_NOT_IMPLEMENT" | "FUNCTION_ID_CANNOT_BE_CHANGED" | "FUNCTION_NOT_FOUND" | "FUNCTION_PENDING_DELETION" | "INVALID" | "INVALID_METAFIELDS" | "MAXIMUM_ACTIVE_PAYMENT_CUSTOMIZATIONS" | "PAYMENT_CUSTOMIZATION_FUNCTION_NOT_ELIGIBLE" | "PAYMENT_CUSTOMIZATION_NOT_FOUND" | "REQUIRED_INPUT_FIELD"

/**
 * Some of the payment methods used in Shopify.
 */
export type PaymentMethods = "AMERICAN_EXPRESS" | "BANCONTACT" | "BITCOIN" | "BOGUS" | "CARTES_BANCAIRES" | "DANKORT" | "DINERS_CLUB" | "DISCOVER" | "DOGECOIN" | "EFTPOS" | "ELO" | "FORBRUGSFORENINGEN" | "INTERAC" | "JCB" | "LITECOIN" | "MAESTRO" | "MASTERCARD" | "PAYPAL" | "UNIONPAY" | "VISA"
 ...
 */
export type PayoutSortKeys = "ADJUSTMENT_GROSS" | "ADVANCE_GROSS" | "AMOUNT" | "CHARGE_GROSS" | "DUTIES_GROSS" | "FEE_AMOUNT" | "ID" | "ISSUED_AT" | "REFUND_GROSS" | "SHIPPING_LABEL_GROSS" | "STATUS"
 ...
 */
export type PriceListFixedPricesByProductBulkUpdateUserErrorCode = "DUPLICATE_ID_IN_INPUT" | "ID_MUST_BE_MUTUALLY_EXCLUSIVE" | "NO_UPDATE_OPERATIONS_SPECIFIED" | "PRICES_TO_ADD_CURRENCY_MISMATCH" | "PRICE_LIMIT_EXCEEDED" | "PRICE_LIST_DOES_NOT_EXIST" | "PRODUCT_DOES_NOT_EXIST"
 ...
 */
export type PriceListPriceUserErrorCode = "BLANK" | "PRICE_LIST_CURRENCY_MISMATCH" | "PRICE_LIST_NOT_FOUND" | "PRICE_NOT_FIXED" | "VARIANT_NOT_FOUND"
 ...
 */
export type PriceListUserErrorCode = "BLANK" | "CATALOG_CONTEXT_DOES_NOT_SUPPORT_QUANTITY_PRICE_BREAKS" | "CATALOG_CONTEXT_DOES_NOT_SUPPORT_QUANTITY_RULES" | "CATALOG_DOES_NOT_EXIST" | "CATALOG_MARKET_AND_PRICE_LIST_CURRENCY_MISMATCH" | "CATALOG_TAKEN" | "CONTEXT_RULE_LIMIT_ONE_OPTION" | "COUNTRY_PRICE_LIST_ASSIGNMENT" | "CURRENCY_MARKET_MISMATCH" | "CURRENCY_NOT_SUPPORTED" | "GENERIC_ERROR" | "INCLUSION" | "INVALID_ADJUSTMENT_MAX_VALUE" | "INVALID_ADJUSTMENT_MIN_VALUE" | "INVALID_ADJUSTMENT_VALUE" | "PRICE_LIST_LOCKED" | "PRICE_LIST_NOT_ALLOWED_FOR_PRIMARY_MARKET" | "PRICE_LIST_NOT_FOUND" | "TAKEN" | "TOO_LONG"
 ...
 */
export type PriceRuleFeature = "BULK" | "BUY_ONE_GET_ONE" | "BUY_ONE_GET_ONE_WITH_ALLOCATION_LIMIT" | "QUANTITY_DISCOUNTS" | "SPECIFIC_CUSTOMERS"
 ...
 * The list of features that can be supported by a price rule.
 */
export type PriceRuleTrait = "BULK" | "BUY_ONE_GET_ONE" | "BUY_ONE_GET_ONE_WITH_ALLOCATION_LIMIT" | "QUANTITY_DISCOUNTS" | "SPECIFIC_CUSTOMERS"

/**
 * A country code from the `ISO 3166` standard. e.g. `CA` for Canada.
 */
export type PrivacyCountryCode = "AC" | "AD" | "AE" | "AF" | "AG" | "AI" | "AL" | "AM" | "AN" | "AO" | "AQ" | "AR" | "AS" | "AT" | "AU" | "AW" | "AX" | "AZ" | "BA" | "BB" | "BD" | "BE" | "BF" | "BG" | "BH" | "BI" | "BJ" | "BL" | "BM" | "BN" | "BO" | "BQ" | "BR" | "BS" | "BT" | "BV" | "BW" | "BY" | "BZ" | "CA" | "CC" | "CD" | "CF" | "CG" | "CH" | "CI" | "CK" | "CL" | "CM" | "CN" | "CO" | "CR" | "CU" | "CV" | "CW" | "CX" | "CY" | "CZ" | "DE" | "DJ" | "DK" | "DM" | "DO" | "DZ" | "EC" | "EE" | "EG" | "EH" | "ER" | "ES" | "ET" | "FI" | "FJ" | "FK" | "FM" | "FO" | "FR" | "GA" | "GB" | "GD" | "GE" | "GF" | "GG" | "GH" | "GI" | "GL" | "GM" | "GN" | "GP" | "GQ" | "GR" | "GS" | "GT" | "GU" | "GW" | "GY" | "HK" | "HM" | "HN" | "HR" | "HT" | "HU" | "ID" | "IE" | "IL" | "IM" | "IN" | "IO" | "IQ" | "IR" | "IS" | "IT" | "JE" | "JM" | "JO" | "JP" | "KE" | "KG" | "KH" | "KI" | "KM" | "KN" | "KP" | "KR" | "KW" | "KY" | "KZ" | "LA" | "LB" | "LC" | "LI" | "LK" | "LR" | "LS" | "LT" | "LU" | "LV" | "LY" | "MA" | "MC" | "MD" | "ME" | "MF" | "MG" | "MH" | "MK" | "ML" | "MM" | "MN" | "MO" | "MP" | "MQ" | "MR" | "MS" | "MT" | "MU" | "MV" | "MW" | "MX" | "MY" | "MZ" | "NA" | "NC" | "NE" | "NF" | "NG" | "NI" | "NL" | "NO" | "NP" | "NR" | "NS" | "NU" | "NZ" | "OM" | "PA" | "PE" | "PF" | "PG" | "PH" | "PK" | "PL" | "PM" | "PN" | "PR" | "PS" | "PT" | "PW" | "PY" | "QA" | "RE" | "RO" | "RS" | "RU" | "RW" | "SA" | "SB" | "SC" | "SD" | "SE" | "SG" | "SH" | "SI" | "SJ" | "SK" | "SL" | "SM" | "SN" | "SO" | "SR" | "SS" | "ST" | "SV" | "SX" | "SY" | "SZ" | "TA" | "TC" | "TD" | "TF" | "TG" | "TH" | "TJ" | "TK" | "TL" | "TM" | "TN" | "TO" | "TR" | "TT" | "TV" | "TW" | "TZ" | "UA" | "UG" | "UM" | "US" | "UY" | "UZ" | "VA" | "VC" | "VE" | "VG" | "VI" | "VN" | "VU" | "WF" | "WS" | "XK" | "XX" | "YE" | "YT" | "ZA" | "ZM" | "ZW"
 ...
 */
export type ProductBundleComponentOptionSelectionStatus = "DESELECTED" | "NEW" | "SELECTED" | "UNAVAILABLE"

/**
 * Possible error codes that can be returned by `ProductBundleMutationUserError`.
 */
export type ProductBundleMutationUserErrorCode = "GENERIC_ERROR" | "INVALID_INPUT" | "JOB_ERROR" | "PRODUCT_DOES_NOT_EXIST"

/**
 * Possible error codes that can be returned by `ProductChangeStatusUserError`.
 */
export type ProductChangeStatusUserErrorCode = "COMBINED_LISTINGS_NOT_COMPATIBLE_WITH_SHOP" | "PRODUCT_NOT_FOUND"

/**
 * The set of valid sort keys for products belonging to a collection.
 */
export type ProductCollectionSortKeys = "BEST_SELLING" | "COLLECTION_DEFAULT" | "CREATED" | "ID" | "MANUAL" | "PRICE" | "RELEVANCE" | "TITLE"
 ...
 */
export type ProductOptionUpdateUserErrorCode = "CANNOT_COMBINE_LINKED_AND_NONLINKED_OPTION_VALUES" | "CANNOT_CREATE_VARIANTS_ABOVE_LIMIT" | "CANNOT_DELETE_ALL_OPTION_VALUES_IN_OPTION" | "CANNOT_DELETE_VARIANT_WITHOUT_PERMISSION" | "CANNOT_LEAVE_OPTIONS_WITHOUT_VARIANTS" | "CANNOT_MAKE_CHANGES_IF_VARIANT_IS_MISSING_REQUIRED_SKU" | "DUPLICATED_OPTION_VALUE" | "DUPLICATE_LINKED_OPTION" | "INVALID_METAFIELD_VALUE_FOR_LINKED_OPTION" | "INVALID_NAME" | "INVALID_POSITION" | "KEY_MISSING_IN_INPUT" | "LINKED_METAFIELD_DEFINITION_NOT_FOUND" | "LINKED_OPTIONS_NOT_SUPPORTED_FOR_SHOP" | "LINKED_OPTION_UPDATE_MISSING_VALUES" | "NO_KEY_ON_CREATE" | "OPTION_ALREADY_EXISTS" | "OPTION_DOES_NOT_EXIST" | "OPTION_LINKED_METAFIELD_ALREADY_TAKEN" | "OPTION_NAME_TOO_LONG" | "OPTION_VALUES_OVER_LIMIT" | "OPTION_VALUE_ALREADY_EXISTS" | "OPTION_VALUE_CONFLICTING_OPERATION" | "OPTION_VALUE_DOES_NOT_EXIST" | "OPTION_VALUE_HAS_VARIANTS" | "OPTION_VALUE_NAME_TOO_LONG" | "PRODUCT_DOES_NOT_EXIST" | "PRODUCT_SUSPENDED" | "TOO_MANY_VARIANTS_CREATED" | "UNSUPPORTED_COMBINED_LISTING_PARENT_OPERATION"
 ...
 */
export type ProductOptionsCreateUserErrorCode = "CANNOT_COMBINE_LINKED_METAFIELD_AND_OPTION_VALUES" | "CANNOT_MAKE_CHANGES_IF_VARIANT_IS_MISSING_REQUIRED_SKU" | "DUPLICATED_OPTION_NAME" | "DUPLICATED_OPTION_VALUE" | "DUPLICATE_LINKED_OPTION" | "INVALID_METAFIELD_VALUE_FOR_LINKED_OPTION" | "INVALID_NAME" | "LINKED_METAFIELD_DEFINITION_NOT_FOUND" | "LINKED_METAFIELD_VALUE_WITHOUT_LINKED_OPTION" | "LINKED_OPTIONS_NOT_SUPPORTED_FOR_SHOP" | "MISSING_METAFIELD_VALUES_FOR_LINKED_OPTION" | "NEW_OPTION_WITHOUT_VALUE_FOR_EXISTING_VARIANTS" | "OPTIONS_OVER_LIMIT" | "OPTION_ALREADY_EXISTS" | "OPTION_LINKED_METAFIELD_ALREADY_TAKEN" | "OPTION_NAME_MISSING" | "OPTION_POSITION_MISSING" | "OPTION_VALUES_MISSING" | "OPTION_VALUES_OVER_LIMIT" | "POSITION_OUT_OF_BOUNDS" | "PRODUCT_DOES_NOT_EXIST" | "PRODUCT_SUSPENDED" | "TOO_MANY_VARIANTS_CREATED" | "UNSUPPORTED_COMBINED_LISTING_PARENT_OPERATION"

/**
 * Possible error codes that can be returned by `ProductOptionsDeleteUserError`.
 */
export type ProductOptionsDeleteUserErrorCode = "CANNOT_DELETE_OPTION_WITH_MULTIPLE_VALUES" | "CANNOT_DELETE_VARIANT_WITHOUT_PERMISSION" | "CANNOT_MAKE_CHANGES_IF_VARIANT_IS_MISSING_REQUIRED_SKU" | "CANNOT_USE_NON_DESTRUCTIVE_STRATEGY" | "OPTIONS_DO_NOT_BELONG_TO_THE_SAME_PRODUCT" | "OPTION_DOES_NOT_EXIST" | "PRODUCT_DOES_NOT_EXIST" | "PRODUCT_SUSPENDED" | "UNSUPPORTED_COMBINED_LISTING_PARENT_OPERATION"

/**
 * Possible error codes that can be returned by `ProductOptionsReorderUserError`.
 */
export type ProductOptionsReorderUserErrorCode = "CANNOT_MAKE_CHANGES_IF_VARIANT_IS_MISSING_REQUIRED_SKU" | "DUPLICATED_OPTION_NAME" | "DUPLICATED_OPTION_VALUE" | "MISSING_OPTION_NAME" | "MISSING_OPTION_VALUE" | "MIXING_ID_AND_NAME_KEYS_IS_NOT_ALLOWED" | "NO_KEY_ON_REORDER" | "OPTION_ID_DOES_NOT_EXIST" | "OPTION_NAME_DOES_NOT_EXIST" | "OPTION_VALUE_DOES_NOT_EXIST" | "OPTION_VALUE_ID_DOES_NOT_EXIST" | "PRODUCT_DOES_NOT_EXIST"

/**
 * Possible error codes that can be returned by `ProductSetUserError`.
 */
export type ProductSetUserErrorCode = "CANNOT_COMBINE_LINKED_AND_NONLINKED_OPTION_VALUES" | "CAPABILITY_VIOLATION" | "DUPLICATED_OPTION_NAME" | "DUPLICATED_OPTION_VALUE" | "DUPLICATED_VALUE" | "DUPLICATE_LINKED_OPTION" | "GENERIC_ERROR" | "GIFT_CARDS_NOT_ACTIVATED" | "GIFT_CARD_ATTRIBUTE_CANNOT_BE_CHANGED" | "HANDLE_NOT_UNIQUE" | "ID_NOT_ALLOWED" | "INPUT_MISMATCH" | "INVALID_INPUT" | "INVALID_METAFIELD" | "INVALID_METAFIELD_VALUE_FOR_LINKED_OPTION" | "INVALID_PRODUCT" | "INVALID_VARIANT" | "JOB_ERROR" | "LINKED_METAFIELD_DEFINITION_NOT_FOUND" | "LINKED_OPTIONS_NOT_SUPPORTED_FOR_SHOP" | "METAFIELD_MISMATCH" | "MISSING_FIELD_REQUIRED" | "NOT_FOUND" | "OPTIONS_OVER_LIMIT" | "OPTION_DOES_NOT_EXIST" | "OPTION_VALUES_MISSING" | "OPTION_VALUES_OVER_LIMIT" | "OPTION_VALUE_DOES_NOT_EXIST" | "PRODUCT_DOES_NOT_EXIST" | "PRODUCT_OPTIONS_INPUT_MISSING" | "PRODUCT_VARIANT_DOES_NOT_EXIST" | "VARIANTS_INPUT_MISSING" | "VARIANTS_OVER_LIMIT"

/**
 * The set of valid sort keys for the Product query.
 */
export type ProductSortKeys = "CREATED_AT" | "ID" | "INVENTORY_TOTAL" | "PRODUCT_TYPE" | "PUBLISHED_AT" | "RELEVANCE" | "TITLE" | "UPDATED_AT" | "VENDOR"
 ...
 */
export type ProductVariantRelationshipBulkUpdateUserErrorCode = "CHILD_PRODUCT_VARIANT_CANNOT_BE_COMBINED_LISTING" | "CIRCULAR_REFERENCE" | "DUPLICATE_PRODUCT_VARIANT_RELATIONSHIP" | "EXCEEDED_PRODUCT_VARIANT_RELATIONSHIP_LIMIT" | "FAILED_TO_CREATE" | "FAILED_TO_REMOVE" | "FAILED_TO_UPDATE" | "FAILED_TO_UPDATE_PARENT_PRODUCT_VARIANT_PRICE" | "INVALID_QUANTITY" | "MUST_SPECIFY_COMPONENTS" | "NESTED_PARENT_PRODUCT_VARIANT" | "PARENT_PRODUCT_VARIANT_CANNOT_BE_COMBINED_LISTING" | "PARENT_PRODUCT_VARIANT_CANNOT_BE_GIFT_CARD" | "PARENT_PRODUCT_VARIANT_CANNOT_REQUIRE_SELLING_PLAN" | "PARENT_REQUIRED" | "PRODUCT_EXPANDER_APP_OWNERSHIP_ALREADY_EXISTS" | "PRODUCT_VARIANTS_NOT_COMPONENTS" | "PRODUCT_VARIANTS_NOT_FOUND" | "PRODUCT_VARIANT_RELATIONSHIP_TYPE_CONFLICT" | "UNEXPECTED_ERROR" | "UNSUPPORTED_MULTIPACK_RELATIONSHIP" | "UPDATE_PARENT_VARIANT_PRICE_REQUIRED"

/**
 * The set of valid sort keys for the ProductVariant query.
 */
export type ProductVariantSortKeys = "FULL_TITLE" | "ID" | "INVENTORY_LEVELS_AVAILABLE" | "INVENTORY_MANAGEMENT" | "INVENTORY_POLICY" | "INVENTORY_QUANTITY" | "NAME" | "POPULAR" | "POSITION" | "RELEVANCE" | "SKU" | "TITLE"
 ...
 */
export type ProductVariantsBulkCreateUserErrorCode = "CANNOT_SET_NAME_FOR_LINKED_OPTION_VALUE" | "GREATER_THAN_OR_EQUAL_TO" | "INVALID" | "INVALID_INPUT" | "MUST_BE_FOR_THIS_PRODUCT" | "NEED_TO_ADD_OPTION_VALUES" | "NEGATIVE_PRICE_VALUE" | "NOT_DEFINED_FOR_SHOP" | "NO_KEY_ON_CREATE" | "OPTION_VALUES_FOR_NUMBER_OF_UNKNOWN_OPTIONS" | "PRODUCT_DOES_NOT_EXIST" | "PRODUCT_SUSPENDED" | "SUBSCRIPTION_VIOLATION" | "TOO_MANY_INVENTORY_LOCATIONS" | "TRACKED_VARIANT_LOCATION_NOT_FOUND" | "UNSUPPORTED_COMBINED_LISTING_PARENT_OPERATION" | "VARIANT_ALREADY_EXISTS" | "VARIANT_ALREADY_EXISTS_CHANGE_OPTION_VALUE"

/**
 * Possible error codes that can be returned by `ProductVariantsBulkDeleteUserError`.
 */
export type ProductVariantsBulkDeleteUserErrorCode = "AT_LEAST_ONE_VARIANT_DOES_NOT_BELONG_TO_THE_PRODUCT" | "CANNOT_DELETE_LAST_VARIANT" | "PRODUCT_DOES_NOT_EXIST" | "UNSUPPORTED_COMBINED_LISTING_PARENT_OPERATION"

/**
 * Possible error codes that can be returned by `ProductVariantsBulkReorderUserError`.
 */
export type ProductVariantsBulkReorderUserErrorCode = "DUPLICATED_VARIANT_ID" | "GENERIC_ERROR" | "INVALID_POSITION" | "MISSING_VARIANT" | "PRODUCT_DOES_NOT_EXIST"

/**
 * Possible error codes that can be returned by `ProductVariantsBulkUpdateUserError`.
 */
export type ProductVariantsBulkUpdateUserErrorCode = "BLANK" | "CANNOT_SET_NAME_FOR_LINKED_OPTION_VALUE" | "CANNOT_SPECIFY_BOTH" | "GREATER_THAN_OR_EQUAL_TO" | "INVALID_INPUT" | "INVALID_VALUE" | "MUST_BE_FOR_THIS_PRODUCT" | "MUST_SPECIFY_ONE_OF_PAIR" | "NEED_TO_ADD_OPTION_VALUES" | "NEGATIVE_PRICE_VALUE" | "NOT_DEFINED_FOR_SHOP" | "NO_INVENTORY_QUANTITES_DURING_UPDATE" | "NO_INVENTORY_QUANTITIES_ON_VARIANTS_UPDATE" | "OPTION_DOES_NOT_EXIST" | "OPTION_VALUES_FOR_NUMBER_OF_UNKNOWN_OPTIONS" | "OPTION_VALUE_DOES_NOT_EXIST" | "PRODUCT_DOES_NOT_EXIST" | "PRODUCT_SUSPENDED" | "PRODUCT_VARIANT_DOES_NOT_EXIST" | "PRODUCT_VARIANT_ID_MISSING" | "SUBSCRIPTION_VIOLATION" | "TOO_LONG" | "TOO_SHORT" | "UNSUPPORTED_COMBINED_LISTING_PARENT_OPERATION" | "VARIANT_ALREADY_EXISTS"

/**
 * The set of valid sort keys for the ProfileItem query.
 */
export type ProfileItemSortKeys = "CREATED_AT" | "ID" | "INVENTORY_TOTAL" | "PRODUCT_TYPE" | "PUBLISHED_AT" | "RELEVANCE" | "TITLE" | "UPDATED_AT" | "VENDOR"
 ...
 */
export type PublicationUserErrorCode = "BLANK" | "CANNOT_MODIFY_APP_CATALOG" | "CANNOT_MODIFY_APP_CATALOG_PUBLICATION" | "CANNOT_MODIFY_MARKET_CATALOG" | "CANNOT_MODIFY_MARKET_CATALOG_PUBLICATION" | "CATALOG_NOT_FOUND" | "INVALID" | "INVALID_PUBLISHABLE_ID" | "MARKET_NOT_FOUND" | "PRODUCT_TYPE_INCOMPATIBLE_WITH_CATALOG_TYPE" | "PUBLICATION_LOCKED" | "PUBLICATION_NOT_FOUND" | "PUBLICATION_UPDATE_LIMIT_EXCEEDED" | "TAKEN" | "TOO_LONG" | "TOO_SHORT" | "UNSUPPORTED_PUBLICATION_ACTION" | "UNSUPPORTED_PUBLISHABLE_TYPE"
 ...
 */
export type QuantityPricingByVariantUserErrorCode = "BLANK" | "GENERIC_ERROR" | "PRICE_ADD_CURRENCY_MISMATCH" | "PRICE_ADD_DUPLICATE_INPUT_FOR_VARIANT" | "PRICE_ADD_VARIANT_NOT_FOUND" | "PRICE_DELETE_PRICE_NOT_FIXED" | "PRICE_DELETE_VARIANT_NOT_FOUND" | "PRICE_LIST_NOT_FOUND" | "QUANTITY_PRICE_BREAK_ADD_CURRENCY_MISMATCH" | "QUANTITY_PRICE_BREAK_ADD_DUPLICATE_INPUT_FOR_VARIANT_AND_MIN" | "QUANTITY_PRICE_BREAK_ADD_FAILED_TO_SAVE" | "QUANTITY_PRICE_BREAK_ADD_INVALID" | "QUANTITY_PRICE_BREAK_ADD_LIMIT_EXCEEDED" | "QUANTITY_PRICE_BREAK_ADD_MIN_HIGHER_THAN_QUANTITY_RULES_MAX" | "QUANTITY_PRICE_BREAK_ADD_MIN_LOWER_THAN_QUANTITY_RULES_MIN" | "QUANTITY_PRICE_BREAK_ADD_MIN_NOT_A_MULTIPLE_OF_QUANTITY_RULES_INCREMENT" | "QUANTITY_PRICE_BREAK_ADD_PRICE_LIST_PRICE_NOT_FOUND" | "QUANTITY_PRICE_BREAK_ADD_VARIANT_NOT_FOUND" | "QUANTITY_PRICE_BREAK_DELETE_BY_VARIANT_ID_VARIANT_NOT_FOUND" | "QUANTITY_PRICE_BREAK_DELETE_FAILED" | "QUANTITY_PRICE_BREAK_DELETE_NOT_FOUND" | "QUANTITY_RULE_ADD_CATALOG_CONTEXT_NOT_SUPPORTED" | "QUANTITY_RULE_ADD_DUPLICATE_INPUT_FOR_VARIANT" | "QUANTITY_RULE_ADD_INCREMENT_IS_GREATER_THAN_MINIMUM" | "QUANTITY_RULE_ADD_INCREMENT_IS_LESS_THAN_ONE" | "QUANTITY_RULE_ADD_INCREMENT_NOT_A_MULTIPLE_OF_QUANTITY_PRICE_BREAK_MIN" | "QUANTITY_RULE_ADD_MAXIMUM_IS_LESS_THAN_ONE" | "QUANTITY_RULE_ADD_MAXIMUM_NOT_A_MULTIPLE_OF_INCREMENT" | "QUANTITY_RULE_ADD_MAX_LOWER_THAN_QUANTITY_PRICE_BREAK_MIN" | "QUANTITY_RULE_ADD_MINIMUM_GREATER_THAN_MAXIMUM" | "QUANTITY_RULE_ADD_MINIMUM_IS_LESS_THAN_ONE" | "QUANTITY_RULE_ADD_MINIMUM_NOT_A_MULTIPLE_OF_INCREMENT" | "QUANTITY_RULE_ADD_MIN_HIGHER_THAN_QUANTITY_PRICE_BREAK_MIN" | "QUANTITY_RULE_ADD_VARIANT_NOT_FOUND" | "QUANTITY_RULE_DELETE_RULE_NOT_FOUND" | "QUANTITY_RULE_DELETE_VARIANT_NOT_FOUND"
 ...
 */
export type QuantityRuleUserErrorCode = "BLANK" | "CATALOG_CONTEXT_DOES_NOT_SUPPORT_QUANTITY_RULES" | "DUPLICATE_INPUT_FOR_VARIANT" | "GENERIC_ERROR" | "GREATER_THAN_OR_EQUAL_TO" | "INCREMENT_IS_GREATER_THAN_MINIMUM" | "INCREMENT_NOT_A_MULTIPLE_OF_QUANTITY_PRICE_BREAK_MINIMUM" | "MAXIMUM_IS_LOWER_THAN_QUANTITY_PRICE_BREAK_MINIMUM" | "MAXIMUM_NOT_MULTIPLE_OF_INCREMENT" | "MINIMUM_IS_GREATER_THAN_MAXIMUM" | "MINIMUM_IS_HIGHER_THAN_QUANTITY_PRICE_BREAK_MINIMUM" | "MINIMUM_NOT_MULTIPLE_OF_INCREMENT" | "PRICE_LIST_DOES_NOT_EXIST" | "PRODUCT_VARIANT_DOES_NOT_EXIST" | "VARIANT_QUANTITY_RULE_DOES_NOT_EXIST"
 ...
 */
export type ResourceAlertSeverity = "CRITICAL" | "DEFAULT" | "ERROR" | "INFO" | "SUCCESS" | "WARNING"
 ...
 */
export type ReturnErrorCode = "ALREADY_EXISTS" | "BLANK" | "CREATION_FAILED" | "EQUAL_TO" | "FEATURE_NOT_ENABLED" | "GREATER_THAN" | "GREATER_THAN_OR_EQUAL_TO" | "INCLUSION" | "INTERNAL_ERROR" | "INVALID" | "INVALID_STATE" | "LESS_THAN" | "LESS_THAN_OR_EQUAL_TO" | "NOTIFICATION_FAILED" | "NOT_A_NUMBER" | "NOT_EDITABLE" | "NOT_FOUND" | "PRESENT" | "TAKEN" | "TOO_BIG" | "TOO_LONG" | "TOO_MANY_ARGUMENTS" | "TOO_SHORT" | "WRONG_LENGTH"
 ...
 */
export type ReverseFulfillmentOrderDispositionType = "MISSING" | "NOT_RESTOCKED" | "PROCESSING_REQUIRED" | "RESTOCKED"
 ...
 */
export type SaleLineType = "ADDITIONAL_FEE" | "ADJUSTMENT" | "DUTY" | "FEE" | "GIFT_CARD" | "PRODUCT" | "SHIPPING" | "TIP" | "UNKNOWN"
 ...
 */
export type SearchResultType = "ARTICLE" | "BALANCE_TRANSACTION" | "BLOG" | "COLLECTION" | "CUSTOMER" | "DISCOUNT_REDEEM_CODE" | "DRAFT_ORDER" | "FILE" | "ORDER" | "PAGE" | "PRICE_RULE" | "PRODUCT" | "URL_REDIRECT"
 ...
 */
export type SellingPlanRemainingBalanceChargeTrigger = "EXACT_TIME" | "NO_REMAINING_BALANCE" | "TIME_AFTER_CHECKOUT"
 ...
 */
export type ServerPixelStatus = "CONNECTED" | "DISCONNECTED_CONFIGURED" | "DISCONNECTED_UNCONFIGURED"
 ...
 */
export type ShopPolicyType = "CONTACT_INFORMATION" | "LEGAL_NOTICE" | "PRIVACY_POLICY" | "REFUND_POLICY" | "SHIPPING_POLICY" | "SUBSCRIPTION_POLICY" | "TERMS_OF_SALE" | "TERMS_OF_SERVICE"

/**
 * Possible error codes that can be returned by `ShopResourceFeedbackCreateUserError`.
 */
export type ShopResourceFeedbackCreateUserErrorCode = "BLANK" | "INVALID" | "OUTDATED_FEEDBACK" | "PRESENT"
 ...
 */
export type ShopifyPaymentsBalanceTransactionPayoutStatus = "ACTION_REQUIRED" | "CANCELED" | "FAILED" | "IN_TRANSIT" | "PAID" | "PENDING" | "SCHEDULED"
 ...
 */
export type ShopifyPaymentsBusinessType = "CORPORATION" | "GOVERNMENT" | "INCORPORATED_PARTNERSHIP" | "INDIVIDUAL" | "LLC" | "NON_PROFIT" | "NON_PROFIT_INCORPORATED" | "NON_PROFIT_REGISTERED_CHARITY" | "NON_PROFIT_UNINCORPORATED" | "NON_PROFIT_UNINCORPORATED_ASSOCIATION" | "NOT_SET" | "PARTNERSHIP" | "PRIVATE_CORPORATION" | "PRIVATE_MULTI_MEMBER_LLC" | "PRIVATE_PARTNERSHIP" | "PRIVATE_SINGLE_MEMBER_LLC" | "PRIVATE_UNINCORPORATED_ASSOCIATION" | "PUBLIC_COMPANY" | "PUBLIC_CORPORATION" | "PUBLIC_PARTNERSHIP" | "SOLE_PROP" | "UNINCORPORATED_PARTNERSHIP"

/**
 * The possible dispute evidence file types.
 */
export type ShopifyPaymentsDisputeEvidenceFileType = "CANCELLATION_POLICY_FILE" | "CUSTOMER_COMMUNICATION_FILE" | "REFUND_POLICY_FILE" | "SERVICE_DOCUMENTATION_FILE" | "SHIPPING_DOCUMENTATION_FILE" | "UNCATEGORIZED_FILE"

/**
 * The reason for the dispute provided by the cardholder's bank.
 */
export type ShopifyPaymentsDisputeReason = "BANK_CANNOT_PROCESS" | "CREDIT_NOT_PROCESSED" | "CUSTOMER_INITIATED" | "DEBIT_NOT_AUTHORIZED" | "DUPLICATE" | "FRAUDULENT" | "GENERAL" | "INCORRECT_ACCOUNT_DETAILS" | "INSUFFICIENT_FUNDS" | "PRODUCT_NOT_RECEIVED" | "PRODUCT_UNACCEPTABLE" | "SUBSCRIPTION_CANCELLED" | "UNRECOGNIZED"

/**
 * Possible error codes that can be returned by `ShopifyPaymentsPayoutAlternateCurrencyCreateUserError`.
 */
export type ShopifyPaymentsPayoutAlternateCurrencyCreateUserErrorCode = "ALTERNATE_CURRENCY_PAYOUT_FAILED_NO_ELIGIBLE_BALANCE" | "ALTERNATE_CURRENCY_PAYOUT_FAILED_STRIPE_ERROR" | "MISSING_PROVIDER_ACCOUNT" | "UNKNOWN_CORE_ERROR"
 ...
 */
export type ShopifyPaymentsPayoutStatus = "CANCELED" | "FAILED" | "IN_TRANSIT" | "PAID" | "SCHEDULED"
 ...
 */
export type ShopifyPaymentsSourceType = "ADJUSTMENT" | "ADJUSTMENT_REVERSAL" | "CHARGE" | "DISPUTE" | "REFUND" | "SYSTEM_ADJUSTMENT" | "TRANSFER"
 ...
 */
export type ShopifyPaymentsTransactionType = "ADJUSTMENT" | "ADVANCE" | "ADVANCE_FUNDING" | "ANOMALY_CREDIT" | "ANOMALY_CREDIT_REVERSAL" | "ANOMALY_DEBIT" | "ANOMALY_DEBIT_REVERSAL" | "APPLICATION_FEE_REFUND" | "BALANCE_TRANSFER_INBOUND" | "BILLING_DEBIT" | "BILLING_DEBIT_REVERSAL" | "CHANNEL_CREDIT" | "CHANNEL_CREDIT_REVERSAL" | "CHANNEL_PROMOTION_CREDIT" | "CHANNEL_PROMOTION_CREDIT_REVERSAL" | "CHANNEL_TRANSFER_CREDIT" | "CHANNEL_TRANSFER_CREDIT_REVERSAL" | "CHANNEL_TRANSFER_DEBIT" | "CHANNEL_TRANSFER_DEBIT_REVERSAL" | "CHARGE" | "CHARGEBACK_FEE" | "CHARGEBACK_FEE_REFUND" | "CHARGEBACK_HOLD" | "CHARGEBACK_HOLD_RELEASE" | "CHARGEBACK_PROTECTION_CREDIT" | "CHARGEBACK_PROTECTION_CREDIT_REVERSAL" | "CHARGEBACK_PROTECTION_DEBIT" | "CHARGEBACK_PROTECTION_DEBIT_REVERSAL" | "CHARGE_ADJUSTMENT" | "COLLECTIONS_CREDIT" | "COLLECTIONS_CREDIT_REVERSAL" | "CUSTOMS_DUTY" | "CUSTOMS_DUTY_ADJUSTMENT" | "DISPUTE_REVERSAL" | "DISPUTE_WITHDRAWAL" | "IMPORT_TAX" | "IMPORT_TAX_ADJUSTMENT" | "IMPORT_TAX_REFUND" | "MARKETPLACE_FEE_CREDIT" | "MARKETPLACE_FEE_CREDIT_REVERSAL" | "MARKETS_PRO_CREDIT" | "MERCHANT_GOODWILL_CREDIT" | "MERCHANT_GOODWILL_CREDIT_REVERSAL" | "MERCHANT_TO_MERCHANT_CREDIT" | "MERCHANT_TO_MERCHANT_CREDIT_REVERSAL" | "MERCHANT_TO_MERCHANT_DEBIT" | "MERCHANT_TO_MERCHANT_DEBIT_REVERSAL" | "PROMOTION_CREDIT" | "PROMOTION_CREDIT_REVERSAL" | "REFUND" | "REFUND_ADJUSTMENT" | "REFUND_FAILURE" | "RESERVED_FUNDS" | "RESERVED_FUNDS_REVERSAL" | "RESERVED_FUNDS_WITHDRAWAL" | "RISK_REVERSAL" | "RISK_WITHDRAWAL" | "SELLER_PROTECTION_CREDIT" | "SELLER_PROTECTION_CREDIT_REVERSAL" | "SHIPPING_LABEL" | "SHIPPING_LABEL_ADJUSTMENT" | "SHIPPING_LABEL_ADJUSTMENT_BASE" | "SHIPPING_LABEL_ADJUSTMENT_SURCHARGE" | "SHIPPING_OTHER_CARRIER_CHARGE_ADJUSTMENT" | "SHIPPING_RETURN_TO_ORIGIN_ADJUSTMENT" | "SHOPIFY_COLLECTIVE_CREDIT" | "SHOPIFY_COLLECTIVE_CREDIT_REVERSAL" | "SHOPIFY_COLLECTIVE_DEBIT" | "SHOPIFY_COLLECTIVE_DEBIT_REVERSAL" | "SHOPIFY_SOURCE_CREDIT" | "SHOPIFY_SOURCE_CREDIT_REVERSAL" | "SHOPIFY_SOURCE_DEBIT" | "SHOPIFY_SOURCE_DEBIT_REVERSAL" | "SHOP_CASH_BILLING_DEBIT" | "SHOP_CASH_BILLING_DEBIT_REVERSAL" | "SHOP_CASH_CAMPAIGN_BILLING_CREDIT" | "SHOP_CASH_CAMPAIGN_BILLING_CREDIT_REVERSAL" | "SHOP_CASH_CAMPAIGN_BILLING_DEBIT" | "SHOP_CASH_CAMPAIGN_BILLING_DEBIT_REVERSAL" | "SHOP_CASH_CREDIT" | "SHOP_CASH_CREDIT_REVERSAL" | "SHOP_CASH_REFUND_DEBIT" | "SHOP_CASH_REFUND_DEBIT_REVERSAL" | "STRIPE_FEE" | "TAX_ADJUSTMENT_CREDIT" | "TAX_ADJUSTMENT_CREDIT_REVERSAL" | "TAX_ADJUSTMENT_DEBIT" | "TAX_ADJUSTMENT_DEBIT_REVERSAL" | "TRANSFER" | "TRANSFER_CANCEL" | "TRANSFER_FAILURE" | "TRANSFER_REFUND" | "VAT_REFUND_CREDIT" | "VAT_REFUND_CREDIT_REVERSAL"
 ...
 */
export type ShopifyProtectStatus = "ACTIVE" | "INACTIVE" | "NOT_PROTECTED" | "PENDING" | "PROTECTED"
 ...
 */
export type StaffMemberPermission = "APPLICATIONS" | "CHANNELS" | "CREATE_AND_EDIT_CUSTOMERS" | "CREATE_AND_EDIT_GIFT_CARDS" | "CREATE_AND_EDIT_MARKETS" | "CUSTOMERS" | "DASHBOARD" | "DEACTIVATE_GIFT_CARDS" | "DELETE_CUSTOMERS" | "DELETE_MARKETS" | "DOMAINS" | "DRAFT_ORDERS" | "EDIT_ORDERS" | "ERASE_CUSTOMER_DATA" | "EXPORT_CUSTOMERS" | "EXPORT_GIFT_CARDS" | "FULL" | "GIFT_CARDS" | "LINKS" | "LOCATIONS" | "MARKETING" | "MARKETING_SECTION" | "MERGE_CUSTOMERS" | "ORDERS" | "OVERVIEWS" | "PAGES" | "PAY_ORDERS_BY_VAULTED_CARD" | "PREFERENCES" | "PRODUCTS" | "REPORTS" | "REQUEST_CUSTOMER_DATA" | "THEMES" | "TRANSLATIONS" | "VIEW_MARKETS"
 ...
 */
export type StagedUploadTargetGenerateUploadResource = "BULK_MUTATION_VARIABLES" | "COLLECTION_IMAGE" | "FILE" | "IMAGE" | "MODEL_3D" | "PRODUCT_IMAGE" | "RETURN_LABEL" | "SHOP_IMAGE" | "URL_REDIRECT_IMPORT" | "VIDEO"

/**
 * Possible error codes that can be returned by `StandardMetafieldDefinitionEnableUserError`.
 */
export type StandardMetafieldDefinitionEnableUserErrorCode = "ADMIN_ACCESS_INPUT_NOT_ALLOWED" | "INVALID" | "INVALID_CAPABILITY" | "INVALID_INPUT_COMBINATION" | "LIMIT_EXCEEDED" | "TAKEN" | "TEMPLATE_NOT_FOUND" | "TYPE_NOT_ALLOWED_FOR_CONDITIONS" | "UNSTRUCTURED_ALREADY_EXISTS" | "UNSUPPORTED_PINNING"

/**
 * Possible error codes that can be returned by `StoreCreditAccountCreditUserError`.
 */
export type StoreCreditAccountCreditUserErrorCode = "ACCOUNT_NOT_FOUND" | "CREDIT_LIMIT_EXCEEDED" | "EXPIRES_AT_IN_PAST" | "MISMATCHING_CURRENCY" | "NEGATIVE_OR_ZERO_AMOUNT" | "OWNER_NOT_FOUND" | "UNSUPPORTED_CURRENCY"

/**
 * Possible error codes that can be returned by `StoreCreditAccountDebitUserError`.
 */
export type StoreCreditAccountDebitUserErrorCode = "ACCOUNT_NOT_FOUND" | "INSUFFICIENT_FUNDS" | "MISMATCHING_CURRENCY" | "NEGATIVE_OR_ZERO_AMOUNT"

/**
 * The event that caused the store credit account transaction.
 */
export type StoreCreditSystemEvent = "ADJUSTMENT" | "ORDER_CANCELLATION" | "ORDER_PAYMENT" | "ORDER_REFUND" | "PAYMENT_FAILURE" | "PAYMENT_RETURNED" | "TAX_FINALIZATION"
 ...
 */
export type SubscriptionBillingAttemptErrorCode = "AMOUNT_TOO_SMALL" | "AUTHENTICATION_ERROR" | "BUYER_CANCELED_PAYMENT_METHOD" | "CARD_NUMBER_INCORRECT" | "CUSTOMER_INVALID" | "CUSTOMER_NOT_FOUND" | "EXPIRED_PAYMENT_METHOD" | "FRAUD_SUSPECTED" | "INSUFFICIENT_FUNDS" | "INSUFFICIENT_INVENTORY" | "INVALID_CUSTOMER_BILLING_AGREEMENT" | "INVALID_PAYMENT_METHOD" | "INVALID_SHIPPING_ADDRESS" | "INVENTORY_ALLOCATIONS_NOT_FOUND" | "INVOICE_ALREADY_PAID" | "NON_TEST_ORDER_LIMIT_REACHED" | "PAYMENT_METHOD_DECLINED" | "PAYMENT_METHOD_INCOMPATIBLE_WITH_GATEWAY_CONFIG" | "PAYMENT_METHOD_NOT_FOUND" | "PAYMENT_PROVIDER_IS_NOT_ENABLED" | "PAYPAL_ERROR_GENERAL" | "PURCHASE_TYPE_NOT_SUPPORTED" | "TEST_MODE" | "TRANSIENT_ERROR" | "UNEXPECTED_ERROR"

/**
 * The inventory policy for a billing attempt.
 */
export type SubscriptionBillingAttemptInventoryPolicy = "ALLOW_OVERSELLING" | "PRODUCT_VARIANT_INVENTORY_POLICY"
 ...
 */
export type SubscriptionBillingCycleBulkUserErrorCode = "BLANK" | "END_DATE_IN_THE_FUTURE" | "INVALID" | "INVALID_DATE_RANGE" | "START_DATE_BEFORE_END_DATE"
 ...
 */
export type SubscriptionBillingCycleScheduleEditInputScheduleEditReason = "BUYER_INITIATED" | "DEV_INITIATED" | "MERCHANT_INITIATED"
 ...
 */
export type SubscriptionContractLastBillingErrorType = "CUSTOMER_ERROR" | "INVENTORY_ERROR" | "OTHER" | "PAYMENT_ERROR"
 ...
 */
export type SubscriptionContractSubscriptionStatus = "ACTIVE" | "CANCELLED" | "EXPIRED" | "FAILED" | "PAUSED"
 ...
 */
export type SubscriptionDiscountRejectionReason = "CURRENTLY_INACTIVE" | "CUSTOMER_NOT_ELIGIBLE" | "CUSTOMER_USAGE_LIMIT_REACHED" | "INCOMPATIBLE_PURCHASE_TYPE" | "INTERNAL_ERROR" | "NOT_FOUND" | "NO_ENTITLED_LINE_ITEMS" | "NO_ENTITLED_SHIPPING_LINES" | "PURCHASE_NOT_IN_RANGE" | "QUANTITY_NOT_IN_RANGE" | "USAGE_LIMIT_REACHED"

/**
 * Possible error codes that can be returned by `SubscriptionDraftUserError`.
 */
export type SubscriptionDraftErrorCode = "ALREADY_REMOVED" | "BILLING_CYCLE_ABSENT" | "BILLING_CYCLE_CONTRACT_DRAFT_BILLING_POLICY_INVALID" | "BILLING_CYCLE_CONTRACT_DRAFT_DELIVERY_POLICY_INVALID" | "BILLING_CYCLE_PRESENT" | "BLANK" | "COMMITTED" | "CONCATENATION_BILLING_CYCLE_CONTRACT_DRAFT_REQUIRED" | "CONCATENATION_UNCOMMITTED_CONTRACT_DRAFT" | "CURRENCY_NOT_ENABLED" | "CUSTOMER_DOES_NOT_EXIST" | "CUSTOMER_MISMATCH" | "CUSTOMER_REDACTED" | "CYCLE_DISCOUNTS_UNIQUE_AFTER_CYCLE" | "CYCLE_INDEX_OUT_OF_RANGE" | "CYCLE_SELECTOR_VALIDATE_ONE_OF" | "CYCLE_START_DATE_OUT_OF_RANGE" | "DELIVERY_METHOD_REQUIRED" | "DELIVERY_MUST_BE_MULTIPLE_OF_BILLING" | "DUPLICATE_CONCATENATED_CONTRACTS" | "EXCEEDED_MAX_CONCATENATED_CONTRACTS" | "GREATER_THAN" | "GREATER_THAN_OR_EQUAL_TO" | "HAS_FUTURE_EDITS" | "INVALID" | "INVALID_ADJUSTMENT_TYPE" | "INVALID_ADJUSTMENT_VALUE" | "INVALID_BILLING_DATE" | "INVALID_LINES" | "INVALID_NOTE_LENGTH" | "LESS_THAN" | "LESS_THAN_OR_EQUAL_TO" | "MISSING_CUSTOMER_PAYMENT_METHOD" | "MISSING_LOCAL_DELIVERY_OPTIONS" | "NOT_AN_INTEGER" | "NOT_IN_RANGE" | "NO_ENTITLED_LINES" | "PRESENCE" | "SELLING_PLAN_MAX_CYCLES_MUST_BE_GREATER_THAN_MIN_CYCLES" | "STALE_CONTRACT" | "TOO_LONG" | "TOO_SHORT" | "UPCOMING_CYCLE_LIMIT_EXCEEDED"
 ...
 */
export type ThemeCreateUserErrorCode = "INVALID_THEME_ROLE_FOR_THEME_CREATION" | "INVALID_ZIP" | "THEME_CREATION_NOT_ALLOWED_FOR_THEME_LIMITED_PLAN" | "ZIP_IS_EMPTY" | "ZIP_TOO_LARGE"
 ...
 */
export type ThemePublishUserErrorCode = "CANNOT_PUBLISH_THEME_DURING_INSTALL" | "NOT_FOUND" | "THEME_PUBLISH_NOT_AVAILABLE_FOR_THEME_LIMITED_PLAN"

/**
 * The role of the theme.
 */
export type ThemeRole = "ARCHIVED" | "DEMO" | "DEVELOPMENT" | "LOCKED" | "MAIN" | "MOBILE" | "UNPUBLISHED"
 ...
 */
export type UnitPriceMeasurementMeasuredUnit = "CL" | "CM" | "G" | "KG" | "L" | "M" | "M2" | "M3" | "MG" | "ML" | "MM"
 ...
 */
export type UrlRedirectBulkDeleteBySavedSearchUserErrorCode = "INVALID_SAVED_SEARCH_QUERY" | "SAVED_SEARCH_NOT_FOUND"
 ...
 */
export type UrlRedirectErrorCode = "CREATE_FAILED" | "DELETE_FAILED" | "DOES_NOT_EXIST" | "UPDATE_FAILED"

/**
 * Possible error codes that can be returned by `UrlRedirectImportUserError`.
 */
export type UrlRedirectImportErrorCode = "ALREADY_IMPORTED" | "FILE_DOES_NOT_EXIST" | "IN_PROGRESS" | "NOT_FOUND"
 ...
 */
export type ValidationUserErrorCode = "APP_NOT_AUTHORIZED" | "BLANK" | "CAPABILITY_VIOLATION" | "CUSTOM_APP_FUNCTION_NOT_ELIGIBLE" | "DISALLOWED_OWNER_TYPE" | "FUNCTION_DOES_NOT_IMPLEMENT" | "FUNCTION_NOT_FOUND" | "FUNCTION_PENDING_DELETION" | "INCLUSION" | "INTERNAL_ERROR" | "INVALID_TYPE" | "INVALID_VALUE" | "MAX_VALIDATIONS_ACTIVATED" | "NOT_FOUND" | "PRESENT" | "PUBLIC_APP_NOT_ALLOWED" | "TAKEN" | "TOO_LONG" | "TOO_SHORT" | "UNSTRUCTURED_RESERVED_NAMESPACE"
